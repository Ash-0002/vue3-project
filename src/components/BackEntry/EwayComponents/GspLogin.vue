...
<template>
    <section class="">
        ...
        <div class="EWayLoginPageDesign">
            <div class="EWAyLoginPageMainPortion" @keydown.esc="closeGspLogin">
                <div class="modal-body text-center p-0">
                    <div class="EWayLoginPageCaption">
                        <button type="button" class="EWayCloseButtonIcon" @click="closeGspLogin">
                                        ...
                                        <b-carousel id="carousel-1" v-model="slide" :interval="0" controls indicators
                                            ...
                                            <b-carousel-slide caption="">
                                                <div class="CarouselImageEWayPage">
                                                    <img src="/assets/images/1.0/png/EWayFirstImage.png"
                                                        alt="image slot" />
                                                </div>
                                                <div class="slide-content-eWayPage">
                                                    <h5><span>Login</span> using NIC credential through the Portal </h5>
                                                    <p><a href="https://ewaybillgst.gov.in/"
                                                            target="_blank">https://ewaybillgst.gov.in/</a></p>
                                                </div>
                                            </b-carousel-slide>

                                            <b-carousel-slide caption="">
                                                <div class="CarouselImageEWayPage">
                                                    <img src="/assets/images/1.0/png/EWaySecondImage.png"
                                                        alt="image slot" />
                                                </div>
                                                <div class="slide-content-eWayPage">
                                                    <h5>Click <span>‘Registration’</span> in the left menu, select For
                                                        GSP
                                                    </h5>
                                                </div>
                                            </b-carousel-slide>
                                            <b-carousel-slide caption="">
                                                <div class="CarouselImageEWayPage">
                                                    <img src="/assets/images/1.0/png/EWayThirdImage.png"
                                                        alt="image slot" />
                                                </div>
                                                <div class="slide-content-eWayPage">
                                                    <h5>Tap <span>‘Send OTP’</span> enter the code sent to your
                                                        registered
                                                        mobile, and tap
                                            ...
                                            <b-carousel-slide caption="">
                                                <div class="CarouselImageEWay CarouselImageEWayPage">
                                                    <img src="/assets/images/1.0/png/EWayFourthImage.png"
                                                        alt="image slot" />
                                                </div>
                                                <div class="slide-content-eWayPage">
                                                    <h5>Click <span>’Add New’</span> & Select <span>‘GSP’</span> then
                                                        select
                                                        <span>‘Fynamics
                                                            Techno Solution’</span>
                                                    </h5>
                                                </div>
                                            </b-carousel-slide>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="EWayLoginFormBoxPage">
                                        <div class="EWayLoginPopupFormPage position-relative mb-4">
                                            ...
                                            <input type="text" v-model="gstinneweWay" placeholder=""
                                                @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                                                v-on:wheel="disableMouseWheelScroll" @input="checkLoginButtonState" ref="gstinneweWay" />
                                        ...
                                        <div class="EWayLoginPopupFormPage position-relative mb-4">
                                            ...
                                            <input type="text" v-model="usernameValue" placeholder=""
                                                @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                                                v-on:wheel="disableMouseWheelScroll" @input="checkLoginButtonState" ref="usernameValue"/>
                                        </div>
                                        <div class="EWayLoginPopupFormPage position-relative mb-4">
                                            <span class="EWayLoginPopupFormLabelPage">GSP PASSWORD</span>
                                            <div class="input-wrapper-GSP-passwordPage">
                                                <input :type="passwordVisibleeWayLogin ? 'text' : 'password'"
                                                    v-model="passwordValue" placeholder="" @keydown="handleKeyDown"
                                                    v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll"
                                                    @input="checkLoginButtonState" ref="passwordValue" />
                                                <span class="eye-icon-gsp-passwordPage"
                                                    @click="togglePasswordVisibility">
                                                    <i
                                                        :class="passwordVisibleeWayLogin ? 'fa fa-eye' : 'fa fa-eye-slash'"></i>
                                                </span>
                                                <span class="error-validation" v-if="ewayErrorFlag">{{
                                                    Eway_Error.UpdateGSPError }}</span>
                                            </div>
                                        </div>
                                        <div class="EWayLoginButtonPage">
                                            <button @click="LogineWayButton" class=""
                                                :disabled="isButtonDisabledLogin || this.button_disabled === '1'">
                                                Save
                                                <span v-show="isLoadingeGSP" class="SpinColorWhite"><i
