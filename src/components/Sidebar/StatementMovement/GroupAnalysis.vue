<template>
  <div>
    <div class="modal-vue-tally">
      <div class="set-popup-main-front-company-modal-design">
        ...
        >
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-4 col-4">
                <div class="company-popup-labelline-icon">
                  <a href="javascript:void(0);" @click="closeGroupAnalysisModalIcon"
          ...
          <div class="tally-front-popup-company">
            ...
            <div class="company-input-boxes">
              ...
              <input
                ...
                v-model="GroupAnalysisSearchModal"
                ref="GroupAnalysisInput"
          ...
          <div class="select-shut-company-flow-boxes">
            ...
            <ul class="company-selection-popup-boxes overflow-stock-query-popup-height-set" ref="GroupAnalysisList">
              <li
      ...
      <div class="overlay2" @click="focusGroupAnalysisModal"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    focusGroupAnalysisModal() {
      //   document.addEventListener("keydown", keydownAddCompanyModal);
      this.$nextTick(() => {
        const inputElement = this.$refs.GroupAnalysisInput;
    ...
    closeGroupAnalysisModalIcon() {
      this.$emit("closeGroupAnalysisModal");
    },
    ...
    selectGroupRow(index) {
      if (this.groupIndex !== index) {
        ...
        alert(this.displayedLedgerList[index].LedgerGropName);
    ...
    handleArrowUp() {
      this.groupIndex =
        (this.groupIndex - 1 + this.displayedLedgerList.length) %
        this.displayedLedgerList.length;

      this.scrollToSelectedRow();
    },

    handleArrowDown() {
      this.groupIndex = (this.groupIndex + 1) % this.displayedLedgerList.length;
    ...
    handleEscapeKey() {
      if (this.GroupAnalysisSearchModal) {
                this.GroupAnalysisSearchModal = "";
    ...
    handleInput() {
      this.searchedGroupName(this.GroupAnalysisSearchModal);
    },
