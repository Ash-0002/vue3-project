    ...
    <div class="modal-vue-tally">
      <div class="set-popup-main-front-company-modal-design">
        <div
          ...
          @click="focusSalesOrderLedgerInput"
        >
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-4 col-4">
                <div class="company-popup-labelline-icon">
                  <a href="javascript:void(0);" @click="closeSalesOrderLedgerModalIcon"
          ...
          <div class="tally-front-popup-company">
            ...
            <div class="company-input-boxes">
              ...
              <input
                ...
                v-model="SalesOrderLedgerSearchModal"
                ref="SalesOrderLedgerInput"
          ...
          <div class="select-shut-company-flow-boxes">
            ...
            <ul class="company-selection-popup-boxes overflow-ledger-indexing-height-set" ref="SalesOrderLedgerList">
              <li
                :class="{ selected: groupIndex == index }"
                v-for="(ledger, index) in displayedSalesOrderLedgerList"
                :key="index"
      ...
      <div class="overlay2" @click="focusSalesOrderLedgerInput"></div>
    </div>
  </div>
</template>
...
export default {
  data() {
    return {
      // SalesOrderLedgerList: [],
      groupIndex: 0,
      currentCompanyName: "",

      SalesOrderLedgerSearchModal: "",
      ledgersList: [],
      displayedSalesOrderLedgerList: [],
  ...
  methods: {
    ...
    focusSalesOrderLedgerInput() {
      //   document.addEventListener("keydown", keydownAddCompanyModal);
      this.$nextTick(() => {
        const inputElement = this.$refs.SalesOrderLedgerInput;
    ...
    closeSalesOrderLedgerModalIcon() {
      this.$emit("closeSalesOrderLedgerModal");
    },
    ...
    selectGroupRow(index) {
      if (this.groupIndex !== index) {
        ...
        this.routeFunction(
          this.displayedSalesOrderLedgerList[index].guid,
          this.displayedSalesOrderLedgerList[index].ledgerName
        );
      }
    },
    ...
    handleEnterKey() {
      this.routeFunction(
        this.displayedSalesOrderLedgerList[this.groupIndex].guid,
        this.displayedSalesOrderLedgerList[this.groupIndex].ledgerName
      );
    },
    ...
    handleArrowDown() {
      ...
      if (this.groupIndex < this.displayedSalesOrderLedgerList.length - 1) {
        this.groupIndex++;
        this.scrollToSelectedRow();
      }
    },
    ...
    scrollToSelectedRow() {
      this.$nextTick(() => {
        ...
        if (this.groupIndex == this.displayedSalesOrderLedgerList.length - 3) {
    ...
    isLastIndexOfLedgerList() {
      const batchSize = 100;
      // const currentLength = this.displayedSalesOrderLedgerList.length;
    ...
    handleEscapeKey() {
      if (this.SalesOrderLedgerSearchModal) {
        this.SalesOrderLedgerSearchModal = "";
        this.searchedGroupName(this.SalesOrderLedgerSearchModal);
        this.ledgersList = [];
        this.displayedSalesOrderLedgerList = [];
        this.getLedgers();
      } else {
        this.$emit("closeSalesOrderLedgerModal");
    ...
    searchedGroupName(name) {
      if (name.trim() == "") {
        // this.displayedSalesOrderLedgerList = this.ledgersList;
        this.ledgersList = [];
        this.displayedSalesOrderLedgerList = [];
        this.getLedgers();
      } else {
        ...
        this.displayedSalesOrderLedgerList = filteredGroupName;
        if(this.displayedSalesOrderLedgerList.length == 0){
      ...
      Api.getLedgersGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.ledgersList = this.displayedSalesOrderLedgerList;
  ...
  mounted() {
    ...
    this.focusSalesOrderLedgerInput();
    this.getLedgers();
  },
};
</script>
