    ...
    <div class="modal-vue-tally">
      <div class="set-popup-main-front-company-modal-design">
        <div
          ...
          @click="focusSalesOrderGroupModal"
        >
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-4 col-4">
                <div class="company-popup-labelline-icon">
                  <a href="javascript:void(0);" @click="closeSalesOrderGroupModalIcon"
          ...
          <div class="tally-front-popup-company">
            ...
            <div class="company-input-boxes">
              ...
              <input
                ...
                v-model="SalesOrderGroupSearchModal"
                ref="SalesOrderGroupInput"
          ...
          <div class="select-shut-company-flow-boxes">
            ...
            <ul class="company-selection-popup-boxes overflow-stock-query-popup-height-set" ref="SalesOrderGroupList">
              <li
                :class="{ selected: SalesOrdergroupIndex == index }"
                v-for="(ledger, index) in displayedSalesOrderGroupList"
                :key="index"
      ...
      <div class="overlay2" @click="focusSalesOrderGroupModal"></div>
    </div>
  </div>
</template>
...
export default {
  data() {
    return {
      // GroupAnalysisList: [],
      SalesOrdergroupIndex: 0,
      currentCompanyName: "",

      SalesOrderGroupSearchModal: "",
      ledgersList: [],
      displayedSalesOrderGroupList: [],
  ...
  methods: {
    ...
    focusSalesOrderGroupModal() {
      //   document.addEventListener("keydown", keydownAddCompanyModal);
      this.$nextTick(() => {
        const inputElement = this.$refs.SalesOrderGroupInput;
    ...
    closeSalesOrderGroupModalIcon() {
      this.$emit("closeSalesOrderGroupModal");
    },

    selectGroupRow(index) {
      if (this.SalesOrdergroupIndex !== index) {
        this.SalesOrdergroupIndex = index;
      } else {
        alert(this.displayedSalesOrderGroupList[index].LedgerGropName);
        this.routeFunction(this.displayedSalesOrderGroupList[index].LedgerGropName);
      }
    },
    ...
    handleEnterKey() {
      this.routeFunction(
        this.displayedSalesOrderGroupList[this.SalesOrdergroupIndex].ledgerGroupName
      );
    },

    handleArrowUp() {
      this.SalesOrdergroupIndex =
        (this.SalesOrdergroupIndex - 1 + this.displayedSalesOrderGroupList.length) %
        this.displayedSalesOrderGroupList.length;

      this.scrollToSelectedRow();
    },

    handleArrowDown() {
      this.SalesOrdergroupIndex = (this.SalesOrdergroupIndex + 1) % this.displayedSalesOrderGroupList.length;
    ...
    scrollToSelectedRow() {
      this.$nextTick(() => {
        ...
        if (selectedRow) {
          ...
          if (this.SalesOrdergroupIndex === 0 && container.scrollTop !== 0) {
            container.scrollTop = 0;
          }
        }

        if (this.SalesOrdergroupIndex == this.displayedSalesOrderGroupList.length - 3) {
    ...
    isLastIndexOfLedgerList() {
      const batchSize = 100; 
      // const currentLength = this.displayedSalesOrderGroupList.length;
    ...
    handleEscapeKey() {
      if (this.SalesOrderGroupSearchModal) {
                this.SalesOrderGroupSearchModal = "";
    ...
    handleInput() {
      this.searchedGroupName(this.SalesOrderGroupSearchModal);
    },

    searchedGroupName(name) {
      if (name.trim() == "") {
        this.displayedSalesOrderGroupList = this.ledgersList;
      } else {
        ...
        this.displayedSalesOrderGroupList = filteredGroupName;
        this.SalesOrdergroupIndex = 0;
      }
    },
      ...
      Api.getLedgerGroupsByCompanyIdGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.displayedSalesOrderGroupList = [
              ...this.displayedSalesOrderGroupList,
              ...this.ledgersList,
            ];

            this.ledgersList = this.displayedSalesOrderGroupList;
  ...
  mounted() {
    ...
    this.focusSalesOrderGroupModal();
    this.getLedgers();
  },
};
</script>
