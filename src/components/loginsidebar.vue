...
*/
<template>
  <section class="new_loginsidebar">
  <div class="">
        <div class="">
          <div class="header_support text-center">
        ...
        <div class="signup_form_new_user" style="display: none">
          <div class="login_form_heading">
            <h3><button class="login_back_signup" @click="register_back()"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>Sign Up</h3>
            <a href="javascript:void(0)" class="closebtn" @click="closeNavVue()">&times;</a>
          </div>
          <div class="signup_form_modal mobile_num_section mt-2">
            <form id="register_from" @submit="register" name="register_from" autocomplete="off">
              
              <div class="form-group">
              
                <input type="text" class="form-control alphabetic" name="firstname" id="firstname" v-model="firstname"
                  placeholder="First Name" autocomplete="off" />
                <span class="error-validation" v-if="this.firstnameError">{{ this.firstnameError }}</span>
              </div>
              <div class="form-group">
             
                <input type="text" class="form-control alphabetic" name="lastname" id="lastname" v-model="lastname"
                  placeholder="Last Name" autocomplete="off" />
                <span class="error-validation" v-if="this.error.lastname">{{ this.error.lastname }}</span>
              </div>
              <div class="form-group">
             
                <div class="register_moble_input">
                <input type="tel" class="form-control register_country_code" v-model="country_code" name="phone_code"
                   placeholder="+91" autocomplete="off" disabled="true" />

                <input type="tel" maxlength="10" class="form-control" name="mobile_number" id="mobile_code"
                  v-model="mobile_number" placeholder="Mobile Number" autocomplete="off" disabled="true" />
                <span class="error-validation" v-if="this.error.mobile_number">{{ this.error.mobile_number }}</span>
              </div>
              </div>
              <div class="form-group">
                <!-- <label>Email Address</label> -->
                <input type="email" class="form-control" name="emailaddress" id="emailaddress" v-model="emailaddress"
                  placeholder="Email Address" autocomplete="off" />
                <span class="error-validation" v-if="this.error.emailaddress">{{ this.error.emailaddress }}</span>
              </div>
              <div class="form-group">
                <!-- <label>Postal Code</label> -->
                <input type="text" class="form-control" name="postalcode" id="postalcode" v-model="postalcode"
                  placeholder="Postal code" autocomplete="off" />
                <span class="error-validation" v-if="this.error.postalcode">{{ this.error.postalcode }}</span>
              </div>
              <div class="form-group">
                <!-- <label>Partner Code</label> -->
                <input type="text" class="form-control" name="partnercode" id="partnercode"
                  placeholder="Partner Code (Optional)" autocomplete="off" v-model="partnercode" />
              </div>
              <!--otp errrr message -->
              <div class="
						  alert alert-danger
						  fade
						  show
						  alert-dismissible alert_otp
						" role="alert" style="display: none" id="partnerErrorMessage">
                <strong><i class="fa fa-info" aria-hidden="true"></i></strong>
                <span id="resellerErrorMessage"></span>
              </div>
              <!--otp errrr message -->
              <div class="form-group text-center register_button_form_right">
                <button
                  type="submit"
                  id="register_button"
                  class="otp_send_btn"
      ...
      <div class="loginsidebar_footer">
        <h5>Trusted by 20k Customers</h5>
        <ul>
          <li>
