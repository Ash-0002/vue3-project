      ...
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-12 col-12">
          <div class="company_name sales_c_name mobile_padding_left_0 company_heading_title">
            ...
            <h3 id="" class="partyName">Balance Sheet</h3>
          </div>
        </div>
          ...
          <ul class="new_set_dropdown_with_gross">
            <li class="marginright25">
              ...
              <div class="parties_datefilter_vue">
                <div
                  class="parties_datefilter_vue only_balancesheet_date_filter"
                >
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="balancesheet_table_main">
              <v-expansion-panels>
                <div class="heading_balancesheet_th">
                  <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                      <div class="bheading-title right_side">
                        <h6 class="green_text">
                          ...
                          {{ debitTotal | formatNumberParties }}
                        </h6>
                      </div>
                    </div>
                  </div>
                ...
                <div
                  v-for="(assets, i) in balancesheet_data.balanceAssets"
                  :key="i"
                >
                  <div v-if="assets.name != 'Profit & Loss A/c'">
                    <v-expansion-panel>
                          ...
                          <div class="row">
                            ...
                            <div class="col-6">
                              <div class="tdheading-title right_side">
                                <h6 class="">
                                  <span class="font_sans">{{ symbol }}</span>
                                  {{ assets.amount | formatNumberParties }}
                                </h6>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="">
                              <div class="balancesheet_under_table">
                                <table class="table balancesheet_table">
                                  ...
                                  <tr v-for="inner_assets in assets.innerArray">
                                    <td>
                                      <router-link
                                        :to="`${inner_assets.url}`"
                                        class="onclick_details"
                                        >{{ inner_assets.parent }}</router-link
                                      >
                                    </td>
                                    <td align="right">
                  ...
                  <div v-else>
                    <div v-if="assets.masterReservedName === 'Difference in Opening Balances'">
                            ...
                            <div class="col-4">
                              <div class="tdheading-title right_side">
                                <h6 class="">
                                  <span class="font_sans">{{ symbol }}</span>
                                  {{
                                    handleMinusSymbol(assets.totalDebitBal)
                                      | formatNumberParties
                                  }}
                                </h6>
                              </div>
                            ...
                            <div class="col-4">
                              <div class="tdheading-title right_side">
                                <h6 class="">
                                  <span class="font_sans">{{ symbol }}</span>
                                  {{
                                    handleMinusSymbol(assets.totalCreditBal)
                                      | formatNumberParties
                                  }}
                                </h6>
                              </div>
                    ...
                    <div v-else class="set-balancesheet-profitloss-bottom">
                      <div class="row">
                        <div class="col-6">
                          <div
                            class="profit-loss-page-redirect-text-balancesheet"
                        ...
                        <div class="col-6">
                          <div
                            class="right_side right-set-amount-balancesheet-profitloss"
                          >
                            <span class="font_sans">{{ symbol }}</span
                            >{{ assets.amount | formatNumberParties }}
                          </div>
              ...
              <v-expansion-panels>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="bheading-title right_side">
                        <h6 class="red_text">
                          <span class="font_sans">{{ symbol }}</span>
                          {{ creditTotal | formatNumberParties }}
                        </h6>
                      </div>
                    </div>
                  </div>
                ...
                <div
                  v-for="(
                    liabilities, i
                  ) in balancesheet_data.balanceLiabilities"
                  :key="i"
                >
                  <div
                    v-if="
                      liabilities.masterReservedName != 'Profit & Loss A/c' &&
                      liabilities.masterReservedName !=
                        'Difference in Opening Balances'
                    "
                  >
                    <v-expansion-panel>
                      <v-expansion-panel-header>
                        ...
                        >
                          <div class="row">
                            <div class="col-6">
                              <div class="tdheading-title">
                                <h6 v-if="liabilities.masterReservedName === '#4; Primary'">
                                  {{ liabilities.name }}
                                </h6>
                                <h6 v-else>
                                  {{ liabilities.masterReservedName }}
                            ...
                            <div class="col-6">
                              <div class="tdheading-title right_side">
                                <h6 class="">
                                  <span class="font_sans">{{ symbol }}</span>
                                  {{ liabilities.amount | formatNumberParties }}
                                </h6>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="">
                              <div class="balancesheet_under_table">
                                <table class="table balancesheet_table">
                                  ...
                                  <tr
                                    v-for="inner_liabilities in liabilities.innerArray"
                                  >
                                    <td>
                                      <router-link
                                        :to="`${inner_liabilities.url}`"
                                        class="onclick_details"
                                        >{{
                                          inner_liabilities.parent
                                        }}</router-link
                                      >
                                    </td>
                                    <td align="right">
                                      ...
                                      {{ inner_liabilities.totalDebitAmount }}
                                    </td>
                                    <td align="right">
                                      <span class="font_sans">{{
                                        symbol
                                      }}</span>
                                      {{ inner_liabilities.totalCreditAmount }}
                                    </td>
                                  </tr>
                  ...
                  <div v-else>
                    <div v-if="liabilities.masterReservedName == 'Difference in Opening Balances'">
...
export default {
  ...
  methods: {
    freeusergeneratePdf() {
      GoogleAnalytics.balancesheet_reports_screen_viewpdf("viewpdf");
    },
    generatePdf() {
      GoogleAnalytics.balancesheet_reports_screen_viewpdf("viewpdf");
      const data = {
      ...
      Api.getPDFForBalancesheetGo(data, headers)
        .then((response) => {
    ...
    left_arrow() {
      ...
      GoogleAnalytics.balancesheet_reports_screen_datepicker(
    ...
    ClosingStock() {
      ...
      Api.getStockItemsGo(data, headers).then((ClosingResponse) => {
        this.ClosingResponse = ClosingResponse.data.data.totalClosingValue;
      });
    },
    balancesheet() {
      var self = this;
      ...
      Api.getBalanceSheetReport(data, headers)
        .then((response) => {
          console.log(response.data, "balancesheet data");
          ...
          if (responseData == "200") {
            ...
            Api.getStockItemsGo(data1, headers1).then((stockresponse) => {
              console.log(stockresponse.data.data, "stockresponse data");
           
              this.totalClosingValue =
                stockresponse.data.data.totalClosingValue;
              for (let [key, value] of Object.entries(
                response.data.data.balanceAssets
              )) {
              if(value.name == "Current Assets"){
                var data = {
                  requestFrom: "WEB",
                  _userId: localStorage.getItem("customerId"),
                  company_id: localStorage.getItem("companyId"),
                  ...
                  GroupName: value.masterReservedName,
                  startLimit: 0,
                  endLimit: 20,
                ...
                Api.getGroupSummaryGo(data, headers).then((response1) => {
                  for (let [key1, value1] of Object.entries(
                    ...
                    if (value1.hasChild == 1) {
                      // Group URL
                      value1.parent = value1.parent.replace("#4; ", "");
                      response1.data.data.list[key1].url =
                        "reportDetails/" + encodeURIComponent(value1.parent);
                    } else {
                      if(value.name == "Current Assets"){
                        response1.data.data.list[key1].url = "/closingstock";
                      }else{
                  ...
                  // if (value.masterReservedName == "Current Assets") {
                   

                  //   if (this.totalClosingValue < 0) {
                  //     this.closingCredit = new Intl.NumberFormat("en-IN", {
                  //       minimumFractionDigits: 2,
                  //     }).format(Math.abs(this.totalClosingValue));
                  //     this.closingDebit = "0";
                      
                  //   } else {
                  //     this.closingCredit = "0";
                  //     this.closingDebit = new Intl.NumberFormat("en-IN", {
                  //       minimumFractionDigits: 2,
                  //     }).format(Math.abs(this.totalClosingValue));
                  //   }
                  //   const Receivables = {
                  ...
                  //     totalCreditAmount: this.closingCredit,
                  //     totalDebitAmount: this.closingDebit,
                  //     closingBalance: {
                  //       credit: this.closingCredit,
                  //       debit: this.closingDebit,
                  //     },
                  //     url: "/closingstock",
                  //   };
                  //   response1.data.data.list.splice(0, 0, Receivables);
                  // }
                  response.data.data.balanceAssets[key].innerArray =
                    response1.data.data.list;
                  response.data.data.balanceAssets[key].amount = Math.abs(
                    response.data.data.balanceAssets[key].amount
                  );
                });
              }
              for (let [key, value] of Object.entries(
                response.data.data.balanceLiabilities
              )) {
                const data = {
                  requestFrom: "WEB",
                  _userId: localStorage.getItem("customerId"),
                ...
                Api.getGroupSummaryGo(data, headers).then((response1) => {
                  for (let [key1, value1] of Object.entries(
                    ...
                    if (value1.hasChild == 1) {
                      ...
                      response1.data.data.list[key1].url =
                        "reportDetails/" +
                        encodeURIComponent(value1.parent.replace("#4;", ""));
                    } else {
                  ...
                  response.data.data.balanceLiabilities[key].innerArray =
                    response1.data.data.list;
                  response.data.data.balanceLiabilities[key].amount = Math.abs(
                    response.data.data.balanceLiabilities[key].amount
                  );
                });
              }
            });
            ...
            this.balancesheet_data = response.data.data;
            console.log(response.data.data, "stockresponse data");
            this.creditTotal = response.data.data.totalBalanceLiabilitiesAmount;
            this.debitTotal = response.data.data.totalBalanceAssetsAmount;
            this.new_loading = false;
          } else {
            this.balancesheet_data = [];
            this.creditTotal = 0;
            this.debitTotal = 0;
            this.new_loading = false;
          }
          console.log(this.balancesheet_data.balanceAssets);
          // }
        })
        .catch((err) => {
          Common.getStatusForActionFailed(err.response.status);
  ...
  mounted() {
    ...
    this.balancesheet();
    GoogleAnalytics.balancesheet_reports_screen_listing();
  },
};
</script>
<style>
  .company_heading_back_button{
