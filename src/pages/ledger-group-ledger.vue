      ...
      <div class="row align-items-center">
        <div class="col-xl-3 col-lg-12 col-12">
          <div class="arrow_left_items">
            <a @click="ResetLedgerState"><i class="fa fa-chevron-left"></i></a>
          </div>
          <div
              ...
              <v-app id="inspire">
                ...
                <div class="show_entries_for_table new_show_entries_for_table">
                  <v-data-table
                    ...
                    :items-per-page="this.$store.state.Web1_Store.Ledger_GroupLedger_itemsPerPage"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      page: this.$store.state.Web1_Store.Ledger_GroupLedger_page,
      totalsalecustomer: 0,
      numberOfPages: 0,
      salecustomer: [],
      value: [],
  ...
  watch: {
    page: function () {
      ...
      this.sale_data();
      GoogleAnalytics.ledger_group_ledger_screen_pagination(this.options.page);
    },
    
    "options.itemsPerPage"() {
      setTimeout(() => {
      const StartIndex = (this.$store.state.Web1_Store.Ledger_GroupLedger_page - 1) * this.$store.state.Web1_Store.Ledger_GroupLedger_itemsPerPage
      const endIndex = StartIndex +  this.$store.state.Web1_Store.Ledger_GroupLedger_itemsPerPage 
     ...
     this.page= this.$store.state.Web1_Store.Ledger_GroupLedger_page
     this.options.page = this.page; 
      ...
      if (this.call_function == "1") {
        ...
        GoogleAnalytics.ledger_group_ledger_screen_Rows_Per_Page(
    ...
    options: {
      handler() {
        GoogleAnalytics.ledger_group_ledger_listing();
      },
    },
    deep: true,
  },
  ...
  computed:{
    currentPage() {
      return this.$store.state.Web1_Store.Ledger_GroupLedger_page;
    },
  ...
  methods: {
    ...
    StoredPage(newValue){
      this.$store.dispatch('Web1_Store/setLedgerGroupLedgerPage', newValue.page)
      

    },
    ResetLedgerState(){
      this.$router.go(-1)
      this.$store.dispatch('Web1_Store/resetLedgerGroupLedgerState')

    },
    updateItemsPerPage(newValue){
      this.$store.dispatch('Web1_Store/setLedgerGroupLedgerItemsPerPage', newValue)
    ...
    activatedate: function (date) {
      if (date === "oned") {
        // one day
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("1D");
        ...
        // one week
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("1W");
        ...
        // one month
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("1M");
        ...
        // 3 month
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("3M");
        var new_date_start_date = moment(String(new Date()))
          .add(-3, "M")
          .format("yyyy-MM-DD");
        var new_date_end_date = moment(String(new Date())).format("yyyy-MM-DD");
        ...
        // 1 Year
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("1Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // 2 Year
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("2Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // max date
        GoogleAnalytics.ledger_group_ledger_screen_date_filter("Max");
        var new_date_start_date = moment(
    ...
    update() {
      ...
      GoogleAnalytics.ledger_group_ledger_screen_date_filter("Custom");
      this.sale_data("", this.groupSelectValue, this.switch_type);
      this.date_setting();
    },
    date_setting() {
    ...
    switch_change(event) {
      ...
      GoogleAnalytics.ledger_group_ledger_screen_filter(event.target.value);
    },
    handleBlur() {
      const type = "search";
      GoogleAnalytics.ledger_group_ledger_screen_search(this.search);
    ...
    updateSort(byDesc, event) {
      ...
      GoogleAnalytics.ledger_group_ledger_screen_sorting(
        this.sortBy,
        this.orderBy
      );
