...
export default {
  ...
  watch: {
    ...
    page: function () {
     ...
     this.voucher_list();
     GoogleAnalytics.cash_voucher_list_screen_pagination(this.options.page);
    },
    ...
    "options.itemsPerPage"() {
     ...
     if(this.call_function == "1"){
        ...
        GoogleAnalytics.cash_voucher_list_screen_Rows_Per_Page(this.options.itemsPerPage);
      }else{
        this.call_function = "1";
      }
    },
    ...
    options: {
      handler() {
        ...
        GoogleAnalytics.cash_voucher_list_listing();
      },
    },
    deep: true,
  },
  ...
  methods: {
    activatedate: function (date) {
      if (date === "oned") {
        // one day
        GoogleAnalytics.cash_voucher_list_screen_date_filter("1D");
        ...
        // one week
        GoogleAnalytics.cash_voucher_list_screen_date_filter("1W");
        ...
        // one month
        GoogleAnalytics.cash_voucher_list_screen_date_filter("1M");
        ...
        // 3 month
        GoogleAnalytics.cash_voucher_list_screen_date_filter("3M");
        var new_date_start_date = moment(String(new Date()))
          .add(-3, "M")
          .format("yyyy-MM-DD");
        var new_date_end_date = moment(String(new Date())).format("yyyy-MM-DD");
        ...
        // 1 Year
        GoogleAnalytics.cash_voucher_list_screen_date_filter("1Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // 2 Year
        GoogleAnalytics.cash_voucher_list_screen_date_filter("2Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // max date
        GoogleAnalytics.cash_voucher_list_screen_date_filter("Max");
        var new_date_start_date = moment(
    ...
    update() {
      ...
      GoogleAnalytics.cash_voucher_list_screen_date_filter("Custom");
      this.voucher_list();
      this.date_setting();
    },
    left_arrow() {
    ...
    updateSort(byDesc, event) {
        ...
        this.voucher_list();
      GoogleAnalytics.cash_voucher_list_screen_sorting(
        this.sortBy,
        this.orderBy
      );
