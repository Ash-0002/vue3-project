                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="company_name sales_c_name padding_left_30">
                                ...
                                <div class="company_balance sales_cb">
                                    <p>Total Purchase Order: <strong><span class="font_sans">₹</span> 24,493.98</strong></p>
                                </div>
                            </div>
                            ...
                            <select name="" id="" class="form-select">
                              ...
                              <option value="excel">Excel</option>
                                    ...
                                    <!-- <div class="col-lg-2 col-md-3 col-sm-6 col-12">
                                        <div class="new_top_table_dropdown">
                                            <select name="" id="" class="form-control custom-select select2"
                                                v-model="dropdownall">
                                                <option value="" disabled>Select</option>
                                                <option v-for="opt in options">{{ opt }}</option>
                                            </select>
                                ...
                                <v-data-table :headers="headers" :items="daybook" :total-items="daybook.length"
                                    rows-per-page-items="6" hide-action item-key="title">
                                    <template v-slot:item.vouchernumber="{ item }">
                                        <td>
                                            <router-link class="onclick_details"
                                                :to="{name:'purchase-order-ledger-details' }">999</router-link>
                                        </td>
                                    </template>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            endDate: endDate,
            dropdownall: '',
            options: ['Ledger', 'Ledger Group', 'Voucher Type', 'Stoch Item', 'Month', 'Bill'],
            ...
            headers: [
                { text: 'Voucher No', value: 'vouchernumber', align: 'left', sortable: true },
