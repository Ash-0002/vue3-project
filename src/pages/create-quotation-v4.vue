      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-12">
          <div class="company_name sales_c_name mobile_padding_left_0" v-if="this.$route.params.voucher_id">
            <h3 v-if="isTransfer != '0'" class="color-white-text">Quotation</h3>
        ...
        <div class="col-lg-6 col-md-6 col-6 text-right">
          <div class="title_text" v-if="this.$route.params.voucher_id">
            <div>
              <button type="button" class="btn download_border_btn" @click="backentryPdf()">
        ...
        <div class="row">
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              ...
              <ul v-if="partynameDropdownOpen" class="SetScrollbarWidthSize">
                <li v-for="(option, index) in partynameFilteredOptions" :key="option.ledgerName" :data-id="option.name"
                  @mousedown="selectOption('partyname', option)" @click="selectOption('partyname', option)"
          ...
          <div class="col-lg-4 col-12 mb-3">
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              ...
              <input ref="ledgertypeInput" type="text" v-model="ledgertypeSearchQuery"
                ...
                @keydown.enter.prevent="selectActiveOption('ledgertype')" placeholder="Select Ledger"
                :disabled="isTransfer == 1 || selectionDone == false" />
              ...
              <ul v-if="ledgertypeDropdownOpen" class="SetScrollbarWidthSize">
                <li v-for="(option, index) in ledgertypeFilteredOptions" :key="option.value" :data-id="option.name"
                  @mousedown="selectOption('ledgertype', option)" @click="selectOption('ledgertype', option)"
          ...
          <div class="col-lg-4 col-12 mb-2">
            <div class="VoucherNumberNewEntryRechanges">
              ...
              <div v-if="isEditing" class="editVoucherboxRechanges QuotationEditVoucherBoxRechanges"
                ...
                <div v-if="VoucherEditable" class="custominputboxnewentryradioRechanges">
                  ...
                  <div class="onlyinputcustomradioRechanges">
                    <input type="text" :disabled="isDefaultSelected ||
                      isTransfer == 1"" placeholder=" Prefix" class="form-control
                    me-2" @input="validateInput" v-model="custom_prefix" />
                    <input type="number" :disabled="isDefaultSelected ||
                      isTransfer == 1"" placeholder=" Voucher no" class="form-control me-2"
                      v-model="custom_Voucher_number" @keypress="allowOnlyNumbers" /> <input type="text"
                      :disabled="isDefaultSelected || isTransfer == 1""
                ...
                <!-- <div class="mt-3 border-top pt-3 pb-3">
                  <div class="ReferencetypesearchRechanges">
                    ...
                    <input class="mt-3" v-model="billNumberData" v-if="
            ...
            <div class="newbackentryinvoicedateRechanges">
              ...
              <div class="datepicker_image_set">
                ...
                <Datepicker v-model="newinvoiceDate" format="dd MMM yyyy" placeholder="03 Nov 2023"
                  :disabled="isTransfer == 1" :disabled-dates="disabledBookDates"></Datepicker>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-12 mb-2">
            <div class="OtherTypeSearchDropdownRechanges" v-if="usePriceLevels == 'Yes'">
              ...
              <input ref="pricelevelInput" type="text" v-model="pricelevelSearchQuery"
                ...
                :disabled="isTransfer == 1" />
              <button v-if="pricelevelSearchQuery" @click="clearSearch('pricelevel')" class="inputcrossiconRechanges">
                <i class="fa fa-times"></i>
              </button>
              <i v-else class="fa fa-search input-search-icon-Rechanges"></i>
              <ul v-if="pricelevelDropdownOpen" class="SetScrollbarWidthSize">
                <li  v-for="(option, index) in [{ priceLevelName: 'Not Applicable'}, ...pricelevelFilteredOptions]"
                  :data-id="option.name" @mousedown="selectOption('pricelevel', option)"
                  @click="selectOption('pricelevel', option)" :class="{ active: index === pricelevelActiveIndex }"
        ...
        <thead style="padding-bottom: 5px">
          <tr>
            ...
            <th width="6%" style="text-align: center">
              <button class="NewItemNewBackEtryRechanges" @click="AddNewItemClick" :disabled="isTransfer == 1">
                  ...
                  @input="filterTableItemsOptions('Items', $event, index)" @keydown.down.prevent="
                    ...
                    " @keydown.up.prevent="
                      ...
                      " @keydown.enter.prevent="
                        ...
                        " placeholder="Search Item" :disabled="button_disabled === '1' || isTransfer == 1" />
                <button v-if="AddNewItemList[index].tableitemsSearchQuery" @click="clearTableItemsSearch(index)"
                  class="inputcrossiconRechangesTableitems" :disabled="isTransfer == 1">
                  <i class="fa fa-times"></i>
                </button>
            ...
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
                <input ref="quantityInput" type="number" placeholder="0" v-model="addnewitem.itemquantity"
                  ...
                  :disabled="button_disabled === '1' || isTransfer == 1"
            ...
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
                <input type="number" placeholder="0" v-model="addnewitem.itemrate" @keydown="handleKeyDown"
                  @keyup="updateAmount(index)" v-on:keydown="disableArrowKeys" 
                  @focus="toggleTableItemsDropdown('Rate', index, true)"
                  @blur="toggleTableItemsDropdown('Rate', index, false)                 "v-on:wheel="disableMouseWheelScroll"
            ...
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
                <!-- <input
                  ...
                  :disabled="button_disabled === '1' || isTransfer == 1"
                /> -->
                <textarea class="textareatableinner" type="text" placeholder="Enter Notes"
                  v-model="addnewitem.itemdescription" @input="change_description($event, index)"
                  :disabled="button_disabled === '1' || isTransfer == 1"></textarea>
              </div>
            </td>
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
            ...
            <td class="text-center">
              <div class="ActionDeleteIconNewRechanges">
                <a href="javascript:void(0);" class="color-red-icon-delete" @click="removeNewItem(index)"
                  :class="{ disabled: index === 0 }" :disabled="button_disabled === '1' || isTransfer == 1">
        ...
        <div class="col-lg-7 col-12">
          <div class="NarrationBoxesNewBackRechanges mb-2">
            ...
            <div v-if="isTextareaVisible" class="TextareaNarrationRechanges mt-2">
              <textarea ref="narrationInput" name="narration" v-model="narration" rows="1" placeholder="Enter Notes"
                class="w-full" :disabled="isTransfer == '1'" @input="validateWordLimit"></textarea>
            </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      <div class="OtherTypeSearchDropdownRechanges SetHeightAdvancedSettingDropdown">
                        <span class="borderlinetextdropdownRechanges">Buyer's Name</span>
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Buyer's Name" ref="buyersnameInput" :disabled="isTransfer == 1" />
                        <button v-if="buyersnameSearchQuery" @click="
                          AdvancedDropclearSearch(
                            'buyersnameSearchQuery',
                            'BuyerName'
                          )
                          " class="inputcrossiconRechanges" :disabled="isTransfer == 1">
                          <i class="fa fa-times"></i>
                        </button>
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Buyer's Country" ref="buyercountryInput"
                          :disabled="isTransfer == 1" />
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Buyer's State" ref="buyerstateInput" :disabled="isTransfer == 1" />
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Registration Type" ref="buyerregistrationInput"
                          :disabled="isTransfer == 1" />
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="Postal Code" @keydown="handleKeyDown"
                          ...
                          ref="postalcodeInput" :disabled="isTransfer == 1" @input="validatePostal($event)" />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" placeholder="GSTIN" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                          v-on:wheel="disableMouseWheelScroll" v-model="BuyerGstin" :disabled="isTransfer == 1"
                          @input="validateGSTIN" />
                      </div>
                    </div>
                  </div>
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Place of Supply" ref="buyerplaceofsupplyInput"
                          :disabled="isTransfer == 1" />
                        <button v-if="buyerstateSearchQuery" @click="
                          AdvancedDropclearSearch(
                            'buyerplaceofsupplySearchQuery',
                    ...
                    <div class="col-lg-8 col-12 mb-2">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <textarea v-model="buyerAddress" name="Address" rows="1" placeholder="Address" cols="50"
                          :disabled="isTransfer == 1">{{ this.buyerAddress }}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                      ...
                      <div class="OtherTypeSearchDropdownRechanges SetHeightAdvancedSettingDropdown">
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Consignee Name" ref="consigneenameInput"
                          :disabled="isTransfer == 1" />
                        ...
                        <ul v-if="consigneenameDropdownOpen" class="SetScrollbarWidthSize">
                          <li v-for="(
option, index
                            ) in consigneenameFilteredOptions" :key="option.value" :data-id="option.name" :class="{
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" placeholder="GSTIN" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                          ...
                          @keydown.enter="focusConsigneeCountryInput" :disabled="isTransfer == 1"
                          @input="validateGSTIN" />
                      </div>
                    </div>
                  </div>
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Consignee Country" ref="consigneeCountryInput"
                          :disabled="isTransfer == 1" />
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  " @keydown.enter.prevent="
                                    ...
                                    " placeholder="Consignee State" ref="consigneestateInput"
                          :disabled="isTransfer == 1" />
...
option, index
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="Postal Code" @keydown="handleKeyDown"
                          v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll"
                          v-model="consigneePostalCode" ref="consigneePostalcodeInput" :disabled="isTransfer == 1"
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-12 mb-2">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        <span class="AdvancedSettingspanRechanges">Address</span>
                        <textarea v-model="consignee_address" name="Address" rows="1" placeholder="Address"
                          :disabled="isTransfer == 1"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input v-model="dispatch_delivery_note" type="text" placeholder="Dispatch Note"
                          :disabled="isTransfer == 1" />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input v-model="dispatch_doc_no" type="text" placeholder="Document No."
                          :disabled="isTransfer == 1" />
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input v-model="dispatch_bill_no" type="text" placeholder="Bill Number"
                          :disabled="isTransfer == 1" />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" v-model="dispatch_despatch_through" placeholder="Dispatch Through"
                          :disabled="isTransfer == 1" />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" v-model="dispatch_motor_vehicle_no" placeholder="Vehicle Number"
                          :disabled="isTransfer == 1"/>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-2">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" v-model="dispatch_destination" placeholder="Destination"
                          @input="validateWordLimitForDestination" :disabled="isTransfer == 1" />
                      </div>
                    </div>
                  </div>
                </div>
                <div v-bind:class="{
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" v-model="order_no" placeholder="Order Number" :disabled="isTransfer == 1" />
                      </div>
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" v-model="order_terms_of_payment" placeholder=""
                          :disabled="isTransfer == 1" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" v-model="order_other_reference" placeholder="" :disabled="isTransfer == 1" />
                      </div>
                    </div>
                    <div class="col-lg-6 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        <span class="AdvancedSettingspanRechanges">Terms of Delivery</span>
                        <textarea type="text" v-model="order_terms_of_delivery" placeholder=""
                          :disabled="isTransfer == 1"></textarea>
                      </div>
                    </div>
                  </div>
                  <!-- <div class="row">
                    <div class="col-lg-12 col-12 mb-2">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        <span class="AdvancedSettingspanRechanges">Address</span>
                        <textarea name="Address" v-model="order_details_address" rows="1" placeholder="" cols="50"
                          :disabled="isTransfer == 1"></textarea>
                      </div>
                    </div>
                  </div> -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                          v-on:wheel="disableMouseWheelScroll" :disabled="isTransfer == 1" />
                      </div>
                    </div>
                    ...
                    <td width="47%">
                      <div class="TaxSelectoptionDropdownRechanges">
                        <div class="OtherwithTaxesserachableDropdownRechanges">
                          ...
                          <input ref="addtaxesInput" type="text" v-model="addnewtaxesDropdown.addtaxesSearchQuery"
                            ...
                            @input="filterAddTaxesOptions($event, index)" @keydown.down.prevent="
                              ...
                              " @keydown.up.prevent="
                                ...
                                " @keydown.enter.prevent="
                                  ...
                                  " :placeholder="addnewtaxesDropdown.placeholder? addnewtaxesDropdown.placeholder : 'Taxes'" :disabled="isTransfer == 1" />
                          ...
                          <button v-if="addnewtaxesDropdown.addtaxesSearchQuery" @click="clearAddTaxesSearch(index)"
                            class="inputcrossicontaxesRechanges" :disabled="isTransfer == 1">
                            <i class="fa fa-times"></i>
                          </button>
                    ...
                    <td width="47%">
                      <div class="TaxesInputNewBackEntryRechanges position-relative">
                        <div class="ledgeramountwithdrdropdownRechanges">
                          ...
                          <input type="number" placeholder="Amount" v-model="addnewtaxesDropdown.amount"
                    ...
                    <td class="text-right" width="6%">
                      <div class="DeleteicontaxesinnerRechanges pt-2">
                        <a href="javascript:void(0);" @click="removeNewTaxes(index)" :style="{
                          'pointer-events': isTransfer == 1 ? 'none' : 'auto',
                        }">
                          <i class="fa fa-trash"></i>
                        </a>
                      </div>
                    ...
                    <td width="47%">
                      <div class="TaxSelectoptionDropdownRechanges">
                        <div class="OtherwithTaxesserachableDropdownRechanges">
                          ...
                          <input ref="otherledgersInput" type="text" v-model="addotherledgersDropdown.otherledgersSearchQueryDropdown
                            ...
                            @input="filterOtherLedgersOptions($event, index)" @keydown.down.prevent="
                              ...
                              " @keydown.up.prevent="
                                ...
                                " @keydown.enter.prevent="
                                  ...
                                  " placeholder="Enter Ledger" :disabled="isTransfer == 1" />
                          <button v-if="
                            addotherledgersDropdown.otherledgersSearchQueryDropdown
                          " @click="clearOtherLedgersSearch(index)" class="inputcrossicontaxesRechanges">
                            <i class="fa fa-times"></i>
                          </button>
                          <i v-else class="fa fa-search taxesledgerssearchiconRechanges"></i>
                          <ul v-if="
                    ...
                    <td width="47%">
                      <div class="TaxesInputNewBackEntryRechanges">
                        <div class="ledgeramountwithdrdropdownRechanges position-relative">
                          <span class="borderlinetextdropdownTaxesAmountRechanges">Amount</span>
                          <input type="number" placeholder="Amount" v-model="addotherledgersDropdown.amount"
                          ...
                          tax_calculation(index);
                          other_gst_calculation();
                          " v-model="addotherledgersDropdown.crdr" :class="addotherledgersDropdown.crdr == 'CR'
                            ? 'text-green'
                            : 'text-red'
                            " :disabled="isTransfer == 1">
          ...
          <div class="col-lg-12">
            <ul class="d-flex align-items-center justify-content-end">
              <!-- <li v-if="EwayEinvoiceElligible">
                ...
                <button @click="generateEinvoice" class="CreateeInvoiceeWayButtonBottom" :disabled="button_disabled === '1' || isTransfer == 1">
                  Create eInvoice
                </button>
              </li> -->
              <!-- <li v-if="EwayEinvoiceElligible">
                ...
                <button :disabled="button_disabled === '1' || isTransfer == 1" class="CreateeInvoiceeWayButtonBottom" @click="checkLogin">
                  Create eWay
                </button>
              </li> -->
              <li>
                <button v-if="this.$route.params.voucher_id" @click="update_sales"
                  class="CreateVoucherButtonBottomRechanges" :disabled="button_disabled === '1' || isTransfer == 1">
                  Update Voucher
                </button>
    ...
    <b-modal id="eWayBillDetailsModal" size="" title="eWay Bill Details" hide-footer centered>
      <div class="modal-content">
          ...
          <div class="row align-items-center">
            ...
            <div v-else class="col-lg-4 col-12 mb-3">
              <div class="TransportDetailsDropdown">
                <span class="error-validation" v-if="Eway_Error.CheckTransporterName">{{ Eway_Error.CheckTransporterName
                }}</span>
        ...
        <div class="d-flex justify-content-center">
          ...
          <!-- <div class="CreateeWayBillButtonPopup text-center mt-2">
        <button @click="showLoadereWay" type="button">Create eWay Loader</button>
      </div> -->
          <!-- <div class="CreateeWayBillButtonPopup text-center mt-2">
        <button @click="openPopup" type="button">OverLap Popup</button>
      </div> -->
        </div>
        <div v-if="isLoadingeWay" class="loader-overlay">
          <div class="eWayLoaderCaption">
            <div class="loadereWayText"></div>
            <h5>Generating eWay Bill...</h5>
          </div>
        </div>
      </div>
      <div v-if="showPopup" class="OverlapPopupOverlay" @click.self="closePopup">
        <div class="OverlayPopupContent">
          <p>{{ this.ewayerrorMessage }}</p>
...
export default {
    ...
    isDefaultSelected() {
      ...
      if (this.$route.params.voucher_id !== undefined) {
        this.custom_Voucher_number =
          Number(this.customizeVoucherNumber.number) - 1;
      } else {
  ...
  methods: {
    ...
    validateWordLimitForDescription(description) {
      ...
      if (words.length > wordLimit) {
        this.stockItemsError.description =
          "Description exceeds the 100-word limit";
      } else {
        this.stockItemsError.description = "";
      }
    },
    ...
    validateWordLimitForDestination() {
      const wordLimit = 100;
      const words = this.dispatch_destination
        .trim()
        .split(/\s+/)
        .filter((word) => word);
      if (words.length > wordLimit) {
        ...
        this.advancedError.dispatch_destination =
          "Destination exceeds the 100-word limit";
      } else {
        this.advancedError.dispatch_destination = "";
      }
    },
    ...
    backentryPdf() {
      const data = {
        ...
        QuotationId: this.$route.params.voucher_id,
      };
      const headers = {
      ...
      Api.getInvoiceConfigurationsGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.invoice_type =
              CommonResponse.voucherNumberConfiguration.quotation.isSetDefaultNumber;
            this.hidePencilIcon = this.invoice_type;
            this.isEwayStatus = CommonResponse.isEwayStatus;
            this.customizeVoucherNumber =
              CommonResponse.voucherNumberConfiguration.quotation.customizeVoucherNumber;
            ...
            if (this.$route.params.voucher_id !== undefined) {
              this.customizeVoucherNumber.isQuotationNumber =
                Number(
                  response.data.data.vouchers.voucherNumberConfiguration
                    .quotation.customizeVoucherNumber.number
                ) - 1;
            } else {
              this.customizeVoucherNumber.isQuotationNumber =
    ...
    change_godown(event, index) {
      ...
      // Find the full godown object from the list
      const selectedGodown = this.godowns.find(g => g.name === selectedName);
      if (selectedGodown && this.tempItmesObject != "") {
        this.tempItmesObject[index].godownName = selectedGodown.name;
        this.tempItmesObject[index].godownGuid = selectedGodown.guid;
        this.AddNewItemList[index].godownGuid =  selectedGodown.guid;
      }
    },
    ...
    async gst_calculation(index) {
              ...
              if (response.data.status != "0") {
                    ...
                    if (response.data.data.igstApplicable == true) {
                      this.tempItmesObject.push({
                        ...
                        rate:
                          ...
                          ((this.AddNewItemList[key].baseUnits === "#4; Not Applicable" ||
                            this.AddNewItemList[key].baseUnits == undefined)
                            ? ""
                ...
                this.AddNewItemList.forEach((value, key) => {
                  this.tempItmesObject.push({
                    ...
                    godownGuid:this.AddNewItemList[key].godownGuid,
                    rate: parseFloat(this.AddNewItemList[key].itemrate).toFixed(this.totalDecimalValueForRate) +
                      ((this.AddNewItemList[key].baseUnits === "#4; Not Applicable" ||
                        this.AddNewItemList[key].baseUnits == undefined)
                        ? ""
                        : "/" + this.AddNewItemList[key].baseUnits),
      ...
      console.log(
        this.tempItmesObject,
        "final object in gst calculation function"
      );
      // }, 500)
    },
    ...
    add_Sales() {
      ...
      if (parseFloat(this.grandTotal) <= 0) {
        this.stockItemsError["grandTotal"] =
          "PLease make sure that grand total cant be 0";
      }
      if(this.partynameSearchQuery == ''){
        this.stockItemsError['partynameSearchQuery'] = 'please select party first !'
      }
      this.AddNewItemList.forEach((value, key) => {
        if (
          !this.AddNewItemList[key].tableitemsSearchQuery &&
      ...
      if (
        ...
        (this.dispatch_doc_no != "" ||
          this.dispatch_delivery_note != "" ||
          this.dispatch_bill_no != "" ||
          this.dispatch_despatch_through != "" ||
          this.dispatch_motor_vehicle_no != "" ||
      ...
      if (
        ...
        this.consigneenameSearchQuery == "Consignee Name"
      ) {
        this.advancedError["consigneenameSearchQuery"] =
          "Consignee name is Mandatory";
        this.stockItemsError["consigneenameSearchQuery"] =
          "Consignee Name is Mandatory";
        this.errors["consigneenameSearchQuery"] = "Consignee Name is Mandatory";
      }
      if (
        this.buyersnameSearchQuery == "" ||
        this.buyersnameSearchQuery == "Consignee Name"
      ) {
        this.advancedError["buyersnameSearchQuery"] =
          "Buyer's name is Mandatory";
        this.stockItemsError["buyersnameSearchQuery"] =
          "Buyer's Name is Mandatory";
      ...
      if (Object.keys(this.stockItemsError).length === 0) {
        ...
        Api.addQuotationGo(data, headers)
          .then((response) => {
            this.voucher_error = "";
            if (response.data.message == "AUTHENTICATION_FAILED") {
              localStorage.clear();
              ...
              // if(this.ShowEway == false){
              setTimeout(() => {
                this.$router.push({ name: "My Quotations" });
              }, 1000);
              // }
    ...
    get_Sales_data() {
      ...
      Api.getQuotationGo(data, headers)
        .then((response) => {
          const responseData = Common.getStatusForActionFailed(
            response.data.status
          );
          ...
          setTimeout(() => {
            ...
            for (let [key1, value1] of Object.entries(
              ...
              if (value1.billAllocationdetails.length > 0) {
                this.referenceSearchQuery =
                  value1.billAllocationdetails[0].billType;
          ...
          this.createdByName = response.data.data.createdBy;
          this.checkedByName = response.data.data.checkedBy;
          this.updatedByName = response.data.data.updatedBy;
          ...
          this.buyerAddress = response.data.data.basicSenderAddress;
          ...
          if(tempInvoiceDelNotes && tempInvoiceDelNotes.length > 0 ){
              ...
              this.dispatch_shipping_date = this.getFormatedDate(response.data.data.invoiceDelNotes[0].basicShippingDate);
            }
          ...
          this.order_date = this.getFormatedDate(response.data.data.invoiceOrders[0].basicOrderDate);
          this.order_no =
            response.data.data.invoiceOrders[0].basicPurchaseOrderNo;
    ...
    update_sales() {
      ...
      if (Object.keys(this.stockItemsError).length === 0) {
        ...
        const data = {
          _id: this.$route.params.voucher_id,
          voucherType: this.voucherSearchQuery,
          voucherDate: moment(String(this.newinvoiceDate)).format("YYYY-MM-DD"),
          partyGuid: this.ledgerId,
          ledgerPriceLevel: this.pricelevelSearchQuery,
        ...
        Api.updateQuotationGo(data, headers)
          .then((response) => {
            if (response.data.message == "AUTHENTICATION_FAILED") {
              localStorage.clear();
              window.location.href = "/";
        ...
        if (this.voucherEditted) {
          if (this.VoucherEditable) {
            ...
            if (
              ...
              // if (
              //   (this.billNumberData == "" ||
              //     this.billNumberData == "Bill Number") &&
              //   this.referenceSearchQuery == "New Reference"
              // ) {
    ...
    toggleDropdown(dropdownType, open) {
      ...
      if (dropdownType == "partyname") {
        ...
        this.partyDetails()
        setTimeout(() => {
          if (this.selectionDone == false && !open) {
    ...
    async filterTableItemsOptions(datatype,event, index) {
      if (datatype == "Items") {
        ...
        this.$set(this.AddNewItemList[index], "GodownActiveIndex", -1); 
      }
    },
    ...
    selectTableItemsOption(option, index) {
      ...
      const { discountValue  } = this.getPriceAccordingPriceLevel(option, index);
      this.$set(
        this.AddNewItemList[index],
        "itemrate",
       parseFloat(rateValue).toFixed(this.totalDecimalValueForRate)
      );
      this.$set(this.AddNewItemList[index], 'itemdiscount',discountValue)
      this.AddNewItemList[index].tableitemsSearchQuery =
        option.tableitemsSearchQuery;
    ...
    toggleOtherLedgersDropdown(type,index, isOpen) {
      this.search = "";
      this.getaddmoreledger();
      const selectedLedgers = this.AddOtherLedgersListDropdown.map(
        (item, idx) =>
          idx !== index ? item.otherledgersSearchQueryDropdown : null
      ...
      if (isOpen) {
        ...
        const filteredOptions = this.otherledgers2Options
          .map((option) => ({
            ...option,
        ...
        setTimeout(() => {
        if(isOpen == false){
          let Amount = this.AddOtherLedgersListDropdown[index].amount
            this.AddOtherLedgersListDropdown[index].amount = parseFloat(Amount).toFixed(this.totalDecimalValueForRate)
          }
        }, 200);
        }
      }
    ...
    filterOtherLedgersOptions(event, index) {
      ...
      if (query === "") {
        setTimeout(() => {
          this.AddOtherLedgersListDropdown[index].otherledgersFilteredOptions =
    ...
    async AdvancedDropfilterOptions(
      ...
      if (searchProperty === "buyersstatelabel") {
        if (query) {
          this[filteredOptionsName] = options.filter(
            (option) => option.name.toLowerCase().includes(query) // Filter state options based on the query
          );
        } else {
          this[filteredOptionsName] = [...this.stateData];
        }
    ...
    checkLogin() {
      ...
      if (this.BuyerPostalCode == "") {
        this.advancedError.BuyerPostalCode =
          "Buyer's postal code is mandatory for e-way/e-invoice.";
        this.errors.BuyerPostalCode =
          "Buyer's postal code is mandatory for e-way/e-invoice.";
      }
      if (this.consigneePostalCode == "") {
        this.advancedError.consigneePostalCode =
          "consignee Postal Code is mandatory for e-way/e-invoice.";
        this.errors.consigneePostalCode =
          "consignee Postal Code is mandatory for e-way/e-invoice.";
      }
    ...
    generateEinvoice() {
      ...
      if (this.consigneePostalCode == "") {
        this.advancedError.consigneePostalCode =
          "consignee PostalCode postal code is mandatory for e-way/e-invoice.";
        this.errors.consigneePostalCode =
          "consignee PostalCode postal code is mandatory for e-way/e-invoice.";
      }
