            ...
            <div class="col-lg-6 col-12">
              ...
              <div class="company_name sales_c_name padding_left_30">
                ...
                <div class="company_balance sales_cb">
                  <p>
                    Total Purchase:
                    <strong><span class="font_sans">₹</span> 24,493.98</strong>
                  </p>
                </div>
              </div>
            </div>
              ...
              <v-app id="inspire">
                        ...
                        <div class="new_top_table_dropdown">
                          <select
                            ...
                            class="
                              form-select
                              salesFilter
                              sales_receivables_dropdown
                              commondropdownall
                            "
                          >
                            <option value="" disabled>Select</option>
                            <option v-for="opt in optionstwo">{{ opt }}</option>
                          </select>
                        </div>
                      </li>
                ...
                >
                  <template v-slot:item.vouchernumber="{ item }">
                    <td>
                      <router-link
                        class="onclick_details m-0"
                        :to="{ name: 'dashboard-payables-ledger-details' }"
                        >999
                      </router-link>
                  ...
                  <template v-slot:item.amount="{ item }">
                    <td>
                      <p><span class="font_sans">₹</span> 2,71,400.00</p>
                    </td>
                  </template>
  ...
  data() {
    ...
    return {
      ...
      headers: [
        ...
        { text: "Due Days", value: "date" },
        { text: "Due Date", value: "type" },
