        ...
        <div class="col-lg-6 col-md-6 col-6">
          <div class="title_text" v-if="this.$route.params.voucher_id">
            <div v-if="isTransfer != '0'">
              <h4 class="page-title mb-0">Sales Order Voucher</h4>
            </div>
            <div v-else>
              <h4 class="page-title mb-0">Update Sales Order Voucher</h4>
            </div>
          </div>
          <div class="title_text" v-else>
            <h4 class="page-title mb-0">Create Sales Order Voucher</h4>
          </div>
        </div>
        ...
        <div class="new_party_form">
          <div class="row">
            ...
            <div class="col-lg-6 col-12" v-if="usePriceLevels == 'Yes'">
              <div class="mb-4">
                <label class="form_input_lbl">Price Level <span class="error-validation-star">*</span></label>
                      ...
                      <tr v-for="(item, index) in tableRows" :key="item.id">
                        ...
                        <td width="8%">
                          <input type="number" @keydown="handleKeyDown" :disabled="disabled === '1' || isTransfer == '1'"
                            @keyup="amount_calculation(index)" v-model="item.quantity" value="1"
                            placeholder="Quantity" class="form-control qty_demo only-input-disable-all-hide-overlay" v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
                        </td>
                        <td>
                          <input type="number" @keydown="handleKeyDown" :disabled="disabled === '1' || isTransfer == '1'"
                        ...
                        <td>
                          <input type="number" @keydown="handleKeyDown" :disabled="disabled === '1' || isTransfer == '1'"
                            ...
                            class="form-control only-input-disable-all-hide-overlay" @input="checkDiscount(index)" v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
                        </td>
                        <td width="18%">
                          <select :disabled="disabled === '1' || isTransfer == '1'" name="" id=""
                            class="form-select item_select input_light_border_dropdown location_select"
                        ...
                        <td>
                          <input @input="html_tag_notaccept('item.item_description', $event)" type="text" @keyup="amount_calculation(index)"
                            :disabled="disabled === '1' || isTransfer == '1'" placeholder="Item Description"
                            class="form-control only-input-disable-all-hide-overlay" v-model="item.item_description" />
                        </td>
                  ...
                  <div class="editing_table_for_voucher" id="tax_div_move">
                    <table class="new_voucher_table">
                      ...
                      <tr v-if="taxarray != ''" class="inventory_table_tr">
                        <td class="inventory_table_th">Tax</td>
                        <td class="inventory_table_th">Amount</td>
                        <td class="inventory_table_th"></td>
                      </tr>
                        ...
                        <td width="25%">
                          <input @input="html_tag_notaccept('taxSummary.amount', $event)" type="text" :disabled="isTransfer == '1'" :v-model="taxSummary.amount"
                        ...
                        <div class="tab-pane fade" id="dispatchdetails" role="tabpanel" aria-labelledby="dispatchdetails-tab">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="form-group input_new_textbox mb-4">
                                <input @input="html_tag_notaccept('dispatch_doc_no', $event)" type="text" :disabled="isTransfer == '1'" v-model="dispatch_doc_no"
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="form-group input_new_textbox mb-4">
                                <input @input="html_tag_notaccept('dispatch_destination', $event)" type="text" :disabled="isTransfer == '1'" v-model="dispatch_destination"
                        ...
                        <div class="tab-pane fade" id="orderdetails" role="tabpanel" aria-labelledby="orderdetails-tab">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="form-group input_new_textbox mb-4">
                                <input @input="html_tag_notaccept('basicDueDateOfPymt', $event)" type="text" :disabled="isTransfer == '1'" v-model="basicDueDateOfPymt"
                                  placeholder="Mode / Terms of payment" class="form-control only-input-disable-all-hide-overlay" value="" />
                              </div>
                            </div>
                            <div class="col-lg-4">
                              <label class="form_input_lbl">Terms of Delievery</label>
                              <div class="form-group input_new_textbox mb-4">
                                <input @input="html_tag_notaccept('order_terms_of_payment', $event)" type="text" :disabled="isTransfer == '1'" v-model="order_terms_of_payment"
                                  placeholder="Mode / Terms of Delievery" class="form-control only-input-disable-all-hide-overlay" value="" />
                              </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="tab-pane fade" id="ewaybilldetails" role="tabpanel" aria-labelledby="ewaybilldetails-tab">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="form-group input_new_textbox mb-4">
                                <input @input="html_tag_notaccept('eway_bill_number', $event)" type="text" :disabled="isTransfer == '1'" v-model="eway_bill_number"
                ...
                <div class="col-12">
                      ...
                      <table class="new_voucher_table">
                        ...
                        <tr v-for="(ledger, index) in ledger_array" :key="ledger.id">
                          <td>
                            ...
                            <form v-on:click="dropdownChange" autocomplete="off" @submit.prevent>
                          ...
                          <td>
                            <select name="" id="" :disabled="isTransfer == '1'" class="form-select item_select"
                              v-model="ledger.type" @change="gst_calculation();other_gst_calculation();tax_calculation();">
                          ...
                          <td>
                            <input type="number" @keydown="handleKeyDown" :disabled="isTransfer == '1'"
                              ...
                              v-model="ledger.amount" v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
                          </td>
                  ...
                  <div class="col-12">
                    <div>
                      ...
                      <div class="sales-voucher-textarea">
                        <textarea @input="html_tag_notaccept('narration', $event)" id="narration" v-model="narration" :disabled="isTransfer == '1'" name="narration"
                          rows="4" placeholder="Narration" cols="50" class="textarea-disable-not-allowed"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
      ...
      if (voucher_id !== "update") {
        if (this.$route.params.voucher_id === undefined) {
          ...
          if (
            ...
            this.tableRows[index].rate = parseFloat(this.getPriceAccordingPriceLevel(selection, index)).toFixed(2);
          }
        }
    ...
    partySelected(selection, type = "") {
      ...
      if(this.$route.params.voucher_id){
          ...
          console.log(selection.name, "selection data in else condition in partyselcted")
    ...
    tax_calculation(index) {
      ...
      if (this.showledgers == true) {
        this.ledger_array.forEach((number1) => {
          let ledgerAmount = number1.amount === "" || number1.amount === undefined ? 0 : parseFloat(number1.amount);
          if (number1.type == "Debit") {
            this.ledger_amount -= ledgerAmount;
          } else {
            this.ledger_amount += ledgerAmount;
          }
        });
    ...
    add_sales() {
      ...
      if (this.usePriceLevels == "Yes") {
        if (!this.price_level) {
          this.error["price_level"] = "Price Level is required";
      ...
      this.ledger_array.forEach((value, key) => {
        if (value.ledger_name == "Select Ledger Item" || value.ledger_name == "" || value.ledger_name == undefined) {
          ...
          this.addLedger_error["selectLedger"] = "Please select Other Ledger";
          this.error["selectLedger"] = "Please select Other Ledger"
        }
      ...
      if (Object.keys(this.error).length === 0) {
        if(this.error_check == 0){
          ...
          this.final_ledgerEntries.forEach((item, index) => {
            if (item.ledgerGroupParent !== "Duties & Taxes" && item.isMoreLedgerField === "1" && item.ledgerTaxType == "") {
        ...
        Api.addMyVoucher(data, headers)
          .then((response) => {
            ...
            if (response.data.message == "AUTHENTICATION_FAILED") {
              ...
              if(this.voucher_error == "Total 1 errors found in the request."){
                this.voucher_error = "Request Error!";
              }
              $("html, body").animate(
                {
  ...
  if(type !== "update"){  
    ...
    check_price_levels() {
      ...
      Api.getCompanyTallyFeaturesGo(data, headers)
        .then((response) => {
          this.usePriceLevels = response.data.data.companyTallyFeatures.inventoryFeatures.usePriceLevels;
        ...
        .then((response) => {
          ...
          Api.getLedgersByLedgerGroupParentGo(data, headers).then((response) => {
            if (response.data.status != "0") {
              for (let [key, value] of Object.entries(
                ...
                console.log(value.name, "get_Sale_data console")
              }
            }
            this.stateDetails();
            this.consigneestateDetails()
          ...
          setTimeout(() => {
            ...
            for (let [key1, value1] of Object.entries(response.data.data.ledgerEntries)) {
                ...
                console.log(response.data.data.ledgerEntries,"showing taxes values")
                if(value1.isMoreLedgerField === "1" && (value1.ledgerGroupParent).toLowerCase() === "duties & taxes"){
                 console.log(response.data.data.ledgerEntries,"yes i am working inside the taxes condition")
                  this.total_tax += parseFloat(value1.amount);
                  console.log(this.total_tax,"showing taxes")
                  this.taxarray.push(
                    {
            ...
            .then((response) => {
              if (response.data.status != "0") {
                ...
                for (let [key2, value2] of Object.entries(response.data.data.list)) {
                  ...
                  this.addmoreLedger_change(value2, key, "update");
                 break;
                }
               
                this.allledgerselection = response.data.data.list;
              }
            })
            .catch((err) => {
              Common.getStatusForActionFailed(err.response.status)
          ...
          this.consignee_pincode =
            response.data.data.basicConsigneeDetails.shipToPincode;
          ...
          this.basicDueDateOfPymt =
            response.data.data.basicDueDateOfPymt;
          this.order_terms_of_payment = response.data.data.basicOrderTerms;
          this.order_other_reference =
            response.data.data.basicOrderRef;
          // this.order_details_address =
          //   response.data.data.voucherdetails.basicOrderTerms;
          if(response.data.data.voucherdetails.eWayBillDetails.length != "0"){
            this.eway_date =
              response.data.data.voucherdetails.eWayBillDetails[0].billDate;
            this.eway_bill_number =
              response.data.data.voucherdetails.eWayBillDetails[0].billNumber;
          }
    ...
    update_sales() {
      ...
      if (Object.keys(this.error).length === 0) {
        ...
        const data = {
          ...
          transferComment: "",
          partyLedgerName: this.partyName,
          parentType: this.$route.params.voucherTypeName,
          partyLedgerGuid: this.partyGuid,
          voucherNumber: this.voucherNumber,
          narration: this.narration,
          isTransfer: 0,
          ...
          if (priceLevelList.isEmpty) {
            ...
            for (let [priceLevelkey, priceLevel] of Object.entries(
              ...
              if (
                ...
                parseFloat(priceLevel["startValue"]) == 0.0 &&
                parseFloat(priceLevel["endValue"]) != 0.0 &&
                parseFloat(this.tableRows[index].quantity) <=
    ...
    InvoiceConfigurations() {
      ...
      Api.getInvoiceConfigurationsGo(data, headers)
        .then((response) => {
          if (response.data.status != "0") {
            this.invoice_type = response.data.data.vouchers.voucherNumberConfiguration.salesorder.isSetDefaultNumber;
          }
        })
        .catch((err) => {
          // alert("ERROR");
  ...
  mounted() {
    GoogleAnalytics.create_sales_order_voucher_listing();
