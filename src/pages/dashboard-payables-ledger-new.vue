            ...
            <li class="marginright25">
              ...
              <ul class="sortby_filter only_filter_icon">
                <li
                  ...
                  :class="{ active: getFiltersDatahidden == `${filter.value}` }"
                  v-if="key < '3'"
                >
                  {{ filter.name }}
                </li>
                ...
                >
                  <ul class="dropdown_li_active">
                    <li
                      ...
                      @click="activatedue(filter.value)"
                      v-click-outside="closeEventdue"
                      :class="{ active: active_due == `${filter.value}` }"
                      v-if="key >= '3'"
                    >
                      {{ filter.name }}
                    </li>
              ...
              <v-app id="inspire">
                <div class="row align-items-center">
                  ...
                  <div class="col-lg-9 col-sm-12 col-12">
                    ...
                    >
                    <li style="cursor: pointer;" @click="handleOnAccount"><span><strong>On Account: </strong> 
...
export default {
  ...
  data() {
    ...
    return {
      ...
      headers: [
        ...
        { text: "Due Days", value: "daysDifference" },
  ...
  methods: {
    handleOnAccount(){
      this.$router.push({ path: `/payables/ledger/onAccount/${this.$route.params.ledgerGuid}` });
    },
    freeusergeneratePdf() {
        ...
        .then((response) => {
            ...
            if (responseStatus == 200) {
              ...
              for (let [key, value] of Object.entries(
                ...
                // );
                response.data.data.list[key].billDue = moment(response.data.data.list[key].billDue , "YYYY-MM-DD HH:mm:ss").format("DD MMM YYYY")
                response.data.data.list[key].billDate = moment(response.data.data.list[key].billDate , "YYYY-MM-DD HH:mm:ss").format("DD MMM YYYY")
                ...
                if (
                  ...
                  response.data.data.list[key].url =
                    ...
                    "/" +
                    encodeURIComponent(response.data.data.list[key].billRef) + "/" + response.data.data.list[key].billDate
                } else {
                  response.data.data.list[key].url = "#";
                }
              }
