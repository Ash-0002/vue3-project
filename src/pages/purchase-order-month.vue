        ...
        <div class="col-xl-3 col-lg-12 col-12">
          <div class="company_name sales_c_name mobile_padding_left_0">
            <div class="company_balance sales_cb new_title_sales_cb">
              <p>
                Total Purchase Order: <br /><strong><span class="font_sans">{{ symbol }}</span>
              ...
              <ul class="sortby_filter only_filter_icon">
                ...
                <div v-if="showInside" v-click-outside="closeEvent" class="without_inline_filter">
                  <ul class="dropdown_li_active">
                    <li @click="activate('Stock Item')" :class="{ active: active_el == 'Stock Item' }">
                      Stock Item
                    </li>
                      ...
                      <td>
                        <!-- <div v-if="isPaid == '' || isPaid == null">
                          <b-button
                            class="vch_num_all_btn"
                            v-b-modal.customerstatus-popup
                            >{{ formatLastSoldDate(item.monthYear) }}</b-button
                          >
                        </div>
                        <div v-else>
                          <button
...
export default {
  ...
  watch: {
    page: function () {
      ...
      this.sale_data();
      GoogleAnalytics.purchaseorder_month_screen_pagination(this.options.page);
    },
    ...
    "options.itemsPerPage"() {
      ...
      if (this.call_function == "1") {
        ...
        GoogleAnalytics.purchaseorder_month_screen_Rows_Per_Page(
    ...
    options: {
      handler() {
        ...
        GoogleAnalytics.purchaseorder_month_listing();
      },
    },
    deep: true,
  },
  ...
  methods: {
    ...
    freeusergeneratePdf() {
      GoogleAnalytics.purchaseorder_month_screen_viewpdf("viewpdf");
    },
    VoucherPdf(v_id) {
      const data = {
        requestFrom: "WEB",
    ...
    formatLastSoldDate(lastSold) {
      ...
      if (lastSold) {
        if (lastSold == "1900-01-01") {
          ...
          // Assuming lastSold is in the format 'YYYY-MM-DD HH:mm:ss'
          return moment(lastSold).format("MMM YY");
        }
      }
    },
    generatePdf() {
    ...
    activatedate: function (date) {
      if (date === "oned") {
        // one day
        GoogleAnalytics.purchaseorder_month_screen_date_filter("1D");
        ...
        // one week
        GoogleAnalytics.purchaseorder_month_screen_date_filter("1W");
        ...
        // one month
        GoogleAnalytics.purchaseorder_month_screen_date_filter("1M");
        ...
        // 3 month
        GoogleAnalytics.purchaseorder_month_screen_date_filter("3M");
        var new_date_start_date = moment(String(new Date()))
          .add(-3, "M")
          .format("yyyy-MM-DD");
        var new_date_end_date = moment(String(new Date())).format("yyyy-MM-DD");
        ...
        // 1 Year
        GoogleAnalytics.purchaseorder_month_screen_date_filter("1Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // 2 Year
        GoogleAnalytics.purchaseorder_month_screen_date_filter("2Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // max date
        GoogleAnalytics.purchaseorder_month_screen_date_filter("Max");
        var new_date_start_date = moment(
    ...
    updateSort(byDesc, event) {
      ...
      GoogleAnalytics.purchaseorder_month_screen_sorting(
        this.sortBy,
        this.orderBy
      );
    ...
    handleBlur() {
      const type = "search";
      GoogleAnalytics.purchaseorder_month_screen_search(this.search);
    ...
    update() {
      ...
      GoogleAnalytics.purchaseorder_month_screen_date_filter("Custom");
      this.sale_data("", this.groupSelectValue, this.switch_type);
      this.date_setting();
    },
    date_setting() {
