              ...
              <v-app id="inspire">
                ...
                >
                  <v-data-table
                    ...
                    :items="salecustomer"
                    :options.sync="options"
                     :items-per-page="this.$store.state.Web1_Store.Sales_Ledger_itemsPerPage"
                    :server-items-length="totalsalecustomer"
                    :loading="loading"
                    class="elevation-1"
                    must-sort
...
export default {
  ...
  data() {
    ...
    return {
      ...
      page: this.$store.state.Web1_Store.Sales_Ledger_page,
      totalsalecustomer: 0,
      numberOfPages: 0,
      salecustomer: [],
      value: [],
  ...
  watch: {
    ...
    "options.itemsPerPage"() {
      ...
      const StartIndex = (this.$store.state.Web1_Store.Sales_Ledger_page - 1) * this.$store.state.Web1_Store.Sales_Ledger_itemsPerPage
      const endIndex = StartIndex +  this.$store.state.Web1_Store.Sales_Ledger_itemsPerPage 
     ...
     this.page= this.$store.state.Web1_Store.Sales_Ledger_page
     this.options.page = this.page; 
  ...
  computed:{
    currentPage() {
      return this.$store.state.Web1_Store.Sales_Ledger_page;
    },
  ...
  methods: {
    ...
    StoredPage(newValue){
      this.$store.dispatch('Web1_Store/setSalesLedgerPage', newValue.page)
      

    },
    updateItemsPerPage(newValue){
      this.$store.dispatch('Web1_Store/setSalesLedgerItemsPerPage', newValue)
