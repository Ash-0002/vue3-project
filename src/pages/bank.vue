...
export default {
  ...
  watch: {
    page: function () {
      ...
      this.bank();
      GoogleAnalytics.bank_screen_pagination(this.options.page);
    },
    ...
    "options.itemsPerPage"() {
      ...
      if (this.call_function == "1") {
        ...
        GoogleAnalytics.bank_screen_Rows_Per_Page(this.options.itemsPerPage);
      } else {
        this.call_function = "1";
      }
    },
  ...
  methods: {
    activatedate: function (date) {
      if (date === "oned") {
        // one day
        GoogleAnalytics.bank_screen_date_filter("1D");
        ...
        // one week
        GoogleAnalytics.bank_screen_date_filter("1W");
        ...
        // one month
        GoogleAnalytics.bank_screen_date_filter("1M");
        ...
        // 3 month
        GoogleAnalytics.bank_screen_date_filter("3M");
        var new_date_start_date = moment(String(new Date()))
          .add(-3, "M")
          .format("yyyy-MM-DD");
        var new_date_end_date = moment(String(new Date())).format("yyyy-MM-DD");
        ...
        // 1 Year
        GoogleAnalytics.bank_screen_date_filter("1Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // 2 Year
        GoogleAnalytics.bank_screen_date_filter("2Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // max date
        GoogleAnalytics.bank_screen_date_filter("Max");
        var new_date_start_date = moment(
    ...
    update() {
      ...
      GoogleAnalytics.bank_screen_date_filter("Custom");
    ...
    handleBlur() {
      const type = "search";
      GoogleAnalytics.bank_screen_search(this.search);
      this.bank(type, this.groupSelectValue, this.switch_type);
    },
    updateSort(byDesc, event) {
      ...
      GoogleAnalytics.bank_screen_sorting(this.sortBy, this.orderBy);
