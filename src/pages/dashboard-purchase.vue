              ...
              <v-app id="inspire">
                ...
                >
                  <v-data-table
                    ...
                    :items-per-page="
                      this.$store.state.Web1_Store.Purchase_Ledger_itemsPerPage
                    "
...
export default {
  ...
  data() {
    ...
    return {
      ...
      page: this.$store.state.Web1_Store.Purchase_Ledger_page,
      totalsalecustomer: 0,
      numberOfPages: 0,
      salecustomer: [],
      value: [],
  ...
  watch: {
    ...
    "options.itemsPerPage"() {
      ...
      setTimeout(() => {
        const StartIndex =
          (this.$store.state.Web1_Store.Purchase_Ledger_page - 1) *
          this.$store.state.Web1_Store.Purchase_Ledger_itemsPerPage;
        const endIndex =
          StartIndex + this.$store.state.Web1_Store.Purchase_Ledger_itemsPerPage;
        ...
        if (Difference > this.totalsalecustomer) {
          ...
          this.page = this.$store.state.Web1_Store.Purchase_Ledger_page;
          this.options.page = this.page;
        }
      }, 1000);
  ...
  computed: {
    currentPage() {
      return this.$store.state.Web1_Store.Purchase_Ledger_page;
    },
  },
  methods: {
    freeusergeneratePdf() {
    ...
    StoredPage(newValue) {
      this.$store.dispatch("Web1_Store/setPurchaseLedgerPage", newValue.page);
    },
    updateItemsPerPage(newValue) {
      this.$store.dispatch("Web1_Store/setPurchaseLedgerItemsPerPage", newValue);
    },
    generatePdf() {
      GoogleAnalytics.purchase_screen_viewpdf("viewpdf");
      const data = {
