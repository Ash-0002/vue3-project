  ...
  <section class="positio-relative">
    <div class="page-header-title-box bg-green-header-card">
      <div class="row align-items-center">
        <div class="col-lg-6 col-12">
          <div
            class="company_name sales_c_name mobile_padding_left_0"
            v-if="this.$route.params.voucher_id"
          >
            <h3
              v-if="fromMyVoucher && isTransfer == 1"
            ...
            <h3
              v-else-if="fromMyVoucher && (isTransfer == 0 || isTransfer == -1)"
              class="color-white-text"
              style="margin-bottom: 0 !important"
            >
        ...
        <div class="row">
          <div class="col-lg-6 col-12">
            <div class="new-text-updated">
              <div v-if="this.updatedByName">
                <h5>
                  Updated By: <span>{{ this.updatedByName }}</span>
                </h5>
              </div>
              <div v-else>
                <h5>
                  Created By: <span>{{ this.createdByName }}</span>
                </h5>
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-12">
            <div class="new-text-checked">
              <h5>
                Checked By: <span>{{ this.checkedByName }}</span>
              </h5>
            </div>
          </div>
        </div>
    ...
    <div class="TopNewBackEntrySectionRechanges mt-3 ps-1 pe-1">
      <div class="TopInnerBackEntrySectionRechanges">
        <div
          class="qrl_error_box p-0 AddPaddingOnlyError"
          v-if="stockItemsError"
        >
          ...
          <p v-if="stockItemsError.description">
            {{ stockItemsError.description }}
          </p>
          ...
          <p v-if="stockItemsError.grandTotal">
            {{ stockItemsError.grandTotal }}
          </p>
          <p v-if="stockItemsError.hsn_code">{{ stockItemsError.hsn_code }}</p>
          ...
          <p v-if="advancedError.dispatch_destination">
            {{ advancedError.dispatch_destination }}
          </p>
          <p v-if="advancedError.vechileNumberInvalid">
            {{ advancedError.vechileNumberInvalid }}
          </p>
          ...
          <p v-if="advancedError.billNumberData">{{ advancedError.billNumberData }}</p>
        </div>
        <div class="row">
          <div class="col-lg-4 col-12 mb-3">
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              <span
                class="borderlinetextdropdownRechanges backgroundgradientRechanges"
                >Voucher Type</span
              >
              <input
                ref="voucherInput"
          ...
          <div class="col-lg-4 col-12 mb-3">
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              ...
              <ul v-if="partynameDropdownOpen" class="SetScrollbarWidthSize">
                <li
                  v-for="(option, index) in partynameFilteredOptions"
                  :key="index"
                  :data-id="option.name"
                ...
                >
                  <div class="row">
                    <div class="col-8">
                      <div
                        class="partynameleftsearchabledrpdwnRechanges text-left"
                      >
                    ...
                    <div class="col-4">
                      <div
                        class="partynamerightsearchabledrpdwnRechanges text-right"
                      >
                        <p class="mb-0">
          ...
          <div class="col-lg-4 col-12 mb-3">
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              ...
              <input
                ...
                @input="filterOptions('ledgertype')"
              ...
              <ul v-if="ledgertypeDropdownOpen" class="SetScrollbarWidthSize">
                <li
                  v-for="(option, index) in ledgertypeFilteredOptions"
                  :key="option.ledgerName"
                  :data-id="option.name"
          ...
          <div class="col-lg-4 col-12 mb-3">
            <div class="VoucherNumberNewEntryRechanges">
              ...
              <p
                v-if="this.voucherNumber"
                class="mb-0 widthsetvouchernumberRechanges"
              >
                {{ this.voucherNumber }}
              </p>
              ...
              <p class="mb-0 PencilIconRight">
                <a
                  v-if="this.fromMyVoucher && this.isTransfer == 0"
                ...
                <a
                  v-else-if="this.fromMyVoucher && this.isTransfer == 1"
                  href="javascript:void(0);"
                >
                  <i class="fa fa-pencil text-dark" aria-hidden="true"></i>
                </a>
                <a
                  v-else-if="this.isVoucherEditable"
                  href="javascript:void(0);"
                >
                  <i class="fa fa-pencil text-dark" aria-hidden="true"></i>
                </a>
              ...
              >
                <div v-if="VoucherEditable" class="invoice_radio_button">
                  <input
                    ...
                    autocomplete="off"
                  />
                  <label for="defaultRadio" class="fontssetlabelRechanges"
                    >Default</label
                  >
                </div>
                <div
                  v-if="VoucherEditable"
                  class="custominputboxnewentryradioRechanges"
                >
                  <div class="invoice_radio_button">
                    <input
                      ...
                      autocomplete="off"
                    />
                    <label for="customRadio" class="fontssetlabelRechanges"
                      >Custom</label
                    >
                  </div>
                  <div class="onlyinputcustomradioRechanges">
                    <input
                      type="text"
                      :disabled="isDefaultSelected || isDisable"
                      placeholder="Prefix"
                ...
                <span
                  ...
                  v-if="vouchernumberError.custom_Voucher_numberError"
                ...
                <div class="mt-3 border-top pt-3 pb-3">
                  ...
                  <!-- <div class="ReferencetypesearchRechanges">
                    <span class="borderlinetextdropdownRechanges"
                      >Reference Type</span
                    >
                    <input
                      type="text"
                    ...
                    <span
                      class="error-validation"
                      v-if="vouchernumberError.billNumberError"
                    >
                      {{ vouchernumberError.billNumberError }}
                    </span>
                  </div> -->
                  <div class="VoucherNumberReferenceTypePopupNewInput">
                    <div class="row">
                      <div class="col-lg-6 col-12">
                        <div class="VoucherNumberReferenceTypePopupNewInput">
                    <div class="ReferencetypesearchRechanges popupReferenceNumberFirstDiv">
                    <span class="borderlinetextdropdownRechanges">Reference Number</span>
                    <input type="text" v-model="ReferenceNumber"/>
                    <button
                      v-if="ReferenceNumber"
                      class="inputcrossiconRechanges"
                      @click="clearReferenceNumber">
                      <i class="fa fa-times"></i>
                    </button>

                  </div>
                  <span class="error-validation error-reference-validation" v-if="referenceNumberRequiredError">
                    {{ referenceNumberRequiredError }}
                  </span>
                  </div>
                      </div>
                      <div class="col-lg-6 col-12">
                        <!--Reference Date--->
                  <div class="newbackentryinvoicedateRechanges popupReferenceNumberSecondDiv">
              <span class="borderlinetextdropdownRechanges">Reference Date</span>
              <div class="datepicker_image_set">
                <span class="sales_date_img_new">
                  <img src="/assets/images/1.0/sales/calendar.svg" class="img-fluid" />
                </span>
                <Datepicker v-model="newReferenceDate" format="dd MMM yyyy"
                  :disabled="isTransfer == 1" :disabled-dates="disabledDates"></Datepicker>
              </div>
            </div>
                      </div>
                    </div>
                ...
                <div
                  class="SAveCancelButtonRechanges text-right border-top pt-3"
                >
                  <button
                    @click="toggleEdit"
                    class="VoucherCancelButtonRechanges me-2"
                  >
                    Cancel
                  </button>
            ...
            <div class="newbackentryinvoicedateRechanges">
              ...
              <div class="datepicker_image_set">
                ...
                <Datepicker
                  ...
                  :disabled="
                    this.isVoucherEditable ||
                    (this.isTransfer == 1 && this.fromMyVoucher)
                  "
                  :disabled-dates="disabledBookDates"
                ></Datepicker>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-12 mb-3" v-if="usePriceLevels == 'Yes'">
            <div
              class="OtherTypeSearchDropdownRechanges"
            >
              <span
                class="borderlinetextdropdownRechanges backgroundgradientRechanges"
                >Price Level</span
              ...
              <input
                ...
                @input="filterOptions('pricelevel')"
              ...
              <ul v-if="pricelevelDropdownOpen" class="SetScrollbarWidthSize">
                <li
                  v-for="(option, index) in [{ priceLevelName: 'Not Applicable'}, ...pricelevelFilteredOptions]"
                  :key="option.priceLevelName"
                  :data-id="option.name"
           ...
           <div class="col-lg-4 col-12 mb-3" v-if="isbillwise">
            <div class="MainBillReferenceNumberDate">
             <!-- Reference Type Dropdown -->
                  <div class="ReferencetypesearchRechanges OutReferencetypesearchRechanges">
                    <span class="borderlinetextdropdownRechanges" style="background-color: linear-gradient(0deg, #fff, #F1F5F9);">Reference Type</span>
                   ...
                   <!-- Bill number Input -->
                  <div class="ReferencetypesearchRechanges OutReferencetypesearchRechanges" v-if="referenceSearchQuery && referenceSearchQuery !== 'ON Account' && referenceSearchQuery !== 'On Account'">
                    <span class="borderlinetextdropdownRechanges" style="background-color: linear-gradient(0deg, #fff, #F1F5F9);">Bill number</span>
                    <input type="text" v-model="billNumberData" :disabled="isDisable"/>
                  </div>
                  <!--Due Date--->
                  <div class="newbackentryinvoicedateRechanges OutMainBillNumberDueDatePart" v-if="referenceSearchQuery && referenceSearchQuery !== 'ON Account' && referenceSearchQuery !== 'On Account'">
              <label class="VoucherDateRechanges">Due Date</label>
              <div class="datepicker_image_set">
                <span class="sales_date_img_new">
                  <img
                    src="/assets/images/1.0/sales/calendar.svg"
                ...
                <Datepicker v-model="newDueDate" format="dd MMM yyyy"
                  :disabled="isDisable" :disabled-dates="disabledBillDates"></Datepicker>
              </div>
            </div>
                  </div>
          </div>
        ...
        <thead style="padding-bottom: 5px">
          <tr>
            ...
            <th width="6%" style="text-align: center">
              <button
                class="NewItemNewBackEtryRechanges"
            ...
            <td class="text-left">
              ...
              <div class="TableItemsserachableDropdownRechanges">
                <input
                  ...
                  @focus="toggleTableItemsDropdown('Items', index, true)"
                  @blur="toggleTableItemsDropdown('Items', index, false)"
                  @input="filterTableItemsOptions('Items', $event, index)"
                ...
                <button
                  ...
                  @click="clearTableItemsSearch('Items', index)"
                  class="inputcrossiconRechangesTableitems"
                  :disabled="isDisable"
                >
                  <i class="fa fa-times"></i>
                </button>
                <i
                  v-else
                  class="fa fa-search input-search-icon-Rechanges-Tableitems"
                ></i>
                <ul
                  v-if="AddNewItemList[index].tableitemsDropdownOpen"
                  class="SetScrollbarWidthSize"
                >
                  <li
                    v-for="(option, optionIndex) in tableitemsFilteredOptions"
                    :key="option.value"
                    :class="{
                      active:
                        optionIndex ===
                  ...
                  >
                    <div class="row">
                      ...
                      <div class="col-4">
                        <div
                          class="tableitemsrightquantityRechanges text-right"
                        >
                          <p class="mb-0">
                            <span
                              :class="{
            ...
            <td class="text-center">
              <div class="TableItemsserachableDropdownRechanges">
                <input
                  ref="godowninput"
                  type="text"
                  v-model="AddNewItemList[index].selectedgodownsOption"
                  @focus="toggleTableItemsDropdown('Godowns', index, true)"
                  @blur="toggleTableItemsDropdown('Godowns', index, false)"
                  @input="filterTableItemsOptions('Godowns', $event, index)"
                  @keydown.down.prevent="
                    navigateTableItemsDropdown(
                      'Godowns',
                      index,
                ...
                />
                <button
                  v-if="AddNewItemList[index].selectedgodownsOption"
                  @click="clearTableItemsSearch('Godowns', index)"
                  class="inputcrossiconRechangesTableitems"
                  :disabled="isDisable"
                >
                  <i class="fa fa-times"></i>
                ...
                ></i>
                <ul
                  v-if="AddNewItemList[index].GodownDropdownOpen"
                  class="SetScrollbarWidthSize"
                >
                  <li
                    v-for="(option, optionIndex) in filteredGodowns"
                    :key="option.name"
                    :class="{
                      active:
      ...
      <div class="row">
        <div class="col-lg-7 col-12">
          <div class="NarrationBoxesNewBackRechanges mb-2">
            <div
              class="NarrationLabelCloseRechanges cursor-pointer"
            ...
            <div
              ...
              class="TextareaNarrationRechanges mt-2"
            >
              <textarea
                ref="narrationInput"
                name="narration"
                ...
                class="w-full"
                :disabled="isDisable"
                v-model="narrationData"
                @input="validateWordLimit"
              ></textarea>
            </div>
            <span class="error-validation" v-if="isWordLimitExceeded">
              This field must contain at least 3 characters and no more than 100 characters</span
            >
          </div>
          <div class="AdvanceSettingNewBackEntryRechanges">
            ...
            <ul
              class="d-flex align-items-center justify-content-between advancedSetingsulRechanges"
            ...
            <div
              class="mt-3 TabContentDivMainTabSpace"
              v-if="isAdvancedSettingsOpen"
            >
                ...
                >
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      <div
                        class="OtherTypeSearchDropdownRechanges SetHeightAdvancedSettingDropdown"
                      >
                        <span class="borderlinetextdropdownRechanges"
                          >Buyer's Name</span
                        >
                        ...
                        <i
                          v-else
                          class="fa fa-caret-down input-search-icon-Rechanges"
                        ></i>
                        <ul
                          v-if="buyersnameDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(option, index) in buyersnameFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{ active: index === buyersnameActiveIndex }"
                            v-scroll-into-view="index === buyersnameActiveIndex"
                            @mousedown="
                      ...
                      <span
                        class="error-validation"
                        v-if="advancedError.buyersnameSearchQuery"
                      >
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      >
                        ...
                        ></i>
                        <ul
                          v-if="buyercountryDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(
                              option, index
                            ) in buyercountryFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      >
                        ...
                        ></i>
                        <ul
                          v-if="buyerstateDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(option, index) in buyerstateFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{ active: index === buyerstateActiveIndex }"
                            v-scroll-into-view="index === buyerstateActiveIndex"
                            @mousedown="
                              AdvancedDropselectOption(
                                'buyerstateSelectedOption',
                                'buyerstateSearchQuery',
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      >
                        ...
                        <input
                          type="text"
                          v-model="buyerregistrationSearchQuery"
                          @focus="
                            AdvancedDroptoggleDropdown(
                          ...
                          ref="buyerregistrationInput"
                          :disabled="isDisable"
                        />
                        <button
                          v-if="buyerregistrationSearchQuery"
                          @click="
                            AdvancedDropclearSearch(
                              'buyerregistrationSearchQuery',
                              'buyerRegistration'
                        ...
                        ></i>
                        <ul
                          v-if="buyerregistrationDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(
                              option, index
                            ) in buyerregistrationFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{
                            ...
                            v-scroll-into-view="
                              index === buyerregistrationActiveIndex
                            "
                            @mousedown="
                              AdvancedDropselectOption(
                                'buyerregistrationSelectedOption',
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div
                        class="AdvancedSettingInputRechanges position-relative"
                      >
                        <span class="AdvancedSettingspanRechanges"
                          >Postal Code</span
                        >
                        <input
                          type="number"
                          ...
                          ref="postalcodeInput"
                          :disabled="isDisable"
                          @input="(event) => validatePostal(event, 'Buyer')"
                        />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-2">
                      ...
                      >
                        ...
                        <input
                          type="text"
                          v-model="buyerplaceofsupplySearchQuery"
                          @focus="
                            AdvancedDroptoggleDropdown(
                        ...
                        ></i>
                        <ul
                          v-if="buyerplaceofsupplyDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(
                              option, index
                            ) in buyerplaceofsupplyFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{
                              active: index === buyerplaceofsupplyActiveIndex,
                            }"
                            v-scroll-into-view="
                              index === buyerplaceofsupplyActiveIndex
                            "
                            @mousedown="
                              AdvancedDropselectOption(
                                'buyerplaceofsupplySelectedOption',
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-12 mb-3">
                      ...
                      >
                        ...
                        ></i>
                        <ul
                          v-if="consigneenameDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(
                              option, index
                            ) in consigneenameFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{
                            ...
                            v-scroll-into-view="
                              index === consigneenameActiveIndex
                            "
                            @mousedown="
                              AdvancedDropselectOption(
                                'consigneenameSelectedOption',
                      ...
                      <span
                        class="error-validation"
                        v-if="advancedError.consigneenameSearchQuery"
                      >
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      >
                        ...
                        <input
                          ...
                          "
                          placeholder="Consignee's Country"
                          ref="consigneeCountryInput"
                          :disabled="isDisable"
                        />
                        <button
                        ...
                        ></i>
                        <ul
                          v-if="consigneecountryDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(
                              option, index
                            ) in consigneecountryFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{
                            ...
                            v-scroll-into-view="
                              index === consigneecountryActiveIndex
                            "
                            @mousedown="
                              AdvancedDropselectOption(
                                'consigneecountrySelectedOption',
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      >
                        ...
                        <input
                          ...
                          "
                          placeholder="Consignee's State"
                          ref="consigneestateInput"
                          :disabled="isDisable"
                        />
                        <button
                        ...
                        ></i>
                        <ul
                          v-if="consigneestateDropdownOpen"
                          class="SetScrollbarWidthSize"
                        >
                          <li
                            v-for="(
                              option, index
                            ) in consigneestateFilteredOptions"
                            :key="option.value"
                            :data-id="option.name"
                            :class="{
                            ...
                            v-scroll-into-view="
                              index === consigneestateActiveIndex
                            "
                            @mousedown="
                              AdvancedDropselectOption(
                                'consigneestateSelectedOption',
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      ...
                      >
                        ...
                        <span
                          class="error-validation"
                          v-if="advancedError.dispatch_shipping_date"
                        >
                          {{ advancedError.dispatch_shipping_date }}
                        </span>
                      </div>
          ...
          <div class="AddTaxesWithSubTotalMainBoxRechanges">
            <div class="TaxesBGwhiteboxRechanges mb-1">
              <table class="table mb-1">
                <tbody>
                  <tr
                    ...
                    ) in AddNewTaxesListDropdown"
                    :key="addnewtaxesDropdown.id"
                  >
                    ...
                    <td width="47%">
                      <div class="TaxSelectoptionDropdownRechanges">
                        <div class="OtherwithTaxesserachableDropdownRechanges">
                          <span class="borderlinetextdropdownTaxesRechanges"
                            >Taxes</span
                          >
                          <input
                            ref="addtaxesInput"
                            type="text"
                            v-model="addnewtaxesDropdown.addtaxesSearchQuery"
                            @focus="toggleAddTaxesDropdown(index, true)"
                            @blur="toggleAddTaxesDropdown(index, false)"
                            @input="filterAddTaxesOptions($event, index)"
                            @keydown.down.prevent="
                            ...
                            "
                            :placeholder="
                              addnewtaxesDropdown.placeholder
                                ? addnewtaxesDropdown.placeholder
                                : 'Taxes'
                            "
                            :disabled="isDisable"
                          ...
                          >
                          <button
                            v-if="addnewtaxesDropdown.addtaxesSearchQuery"
                            @click="clearAddTaxesSearch(index)"
                          ...
                          <i
                            v-else
                            class="fa fa-search taxesledgerssearchiconRechanges"
                          ></i>
                          <ul
                            v-if="addnewtaxesDropdown.addtaxesDropdownOpen"
                            class="SetScrollbarWidthSize"
                          >
                            <li
                              v-for="(
                                option, optionIndex
                              ) in addnewtaxesDropdown.addtaxesFilteredOptions"
                              :key="option.value"
                              :class="{
                                active:
                                  optionIndex ===
                              ...
                              @mousedown="
                                !option.isSelected &&
                                  selectAddTaxesOption(option, index)
                              "
                            >
                              <div
                                class="itemsnamewithhsnRechanges otherledgers-searchable-Rechanges"
                              >
                    ...
                    <td width="47%">
                      <div
                        class="TaxesInputNewBackEntryRechanges position-relative"
                      >
                        <div class="ledgeramountwithdrdropdownRechanges">
                          <span
                            class="borderlinetextdropdownTaxesAmountRechanges"
                            >Amount</span
                          >
                          <input
                            type="number"
                            placeholder="Amount"
                            v-model="addnewtaxesDropdown.amount"
                            class="border-none"
                            @keydown="handleKeyDown"
                            v-on:keydown="disableArrowKeys"
                            @keyup="tax_value_amount($event, index)"
                        ...
                        <span
                          class="error-validation"
                          v-if="error_tax.amount && error_tax.amount[index]"
              ...
              <div class="AddTaxesFlowNewRechanges mb-2">
                <a
                  href="javascript:void(0);"
                  @click="AddNewTaxesClick"
                  :style="{
                    'pointer-events': isDisable ? 'none' : 'auto',
                  }"
                >
                  <span class="newaddplusnackentryRechanges"
                    ><i class="fa fa-plus me-1"></i> Add Taxes
                  </span>
                </a>
              </div>
            </div>
            ...
            <div class="TaxesBGwhiteboxRechanges mb-1">
              <table class="table mb-1">
                <tbody>
                  <tr
                    ...
                    ) in AddOtherLedgersListDropdown"
                    :key="addotherledgersDropdown.id"
                  >
                    <td width="47%">
                      <div class="TaxSelectoptionDropdownRechanges">
                        <div class="OtherwithTaxesserachableDropdownRechanges">
                          ...
                          <input
                            ...
                            "
                            @input="filterOtherLedgersOptions($event, index)"
                            @keydown.down.prevent="
                          ...
                          <button
                            v-if="
                              addotherledgersDropdown.otherledgersSearchQueryDropdown
                            "
                            @click="clearOtherLedgersSearch(index)"
                            class="inputcrossicontaxesRechanges"
                          >
                            <i class="fa fa-times"></i>
                          </button>
                          ...
                          >
                            <li
                              v-for="(
                                option, optionIndex
                              ) in addotherledgersDropdown.otherledgersFilteredOptions"
                              :key="option.name"
                              :class="{
                                active:
                                  optionIndex ===
                    ...
                    <td width="47%">
                      <div class="TaxesInputNewBackEntryRechanges">
                        <div
                          class="ledgeramountwithdrdropdownRechanges position-relative"
                        >
                          <span
                            class="borderlinetextdropdownTaxesAmountRechanges"
                            >Amount</span
                          ...
                          <input
                            type="number"
                            placeholder="Amount"
                            v-model="addotherledgersDropdown.amount"
                            class="border-none"
                            @keydown="handleKeyDown"
                            @input="
                              updateLedgerArray(
                          ...
                          <select
                            ...
                            :class="
                              addotherledgersDropdown.crdr == 'CR'
                                ? 'text-green'
                                : 'text-red'
                            "
                            :disabled="isDisable"
                    ...
                    <td width="6%">
                      <div
                        class="DeleteicontaxesinnerRechanges text-right pt-2"
                      >
                        <a
                          href="javascript:void(0);"
                          @click="removeOtherLedgers(index)"
                          :style="{
                            'pointer-events': isDisable ? 'none' : 'auto',
                          }"
                        >
              ...
              <div class="AddTaxesFlowNewRechanges mb-1">
                <a
                  href="javascript:void(0);"
                  @click="AddOtherLedgersClick"
                  :style="{
                    'pointer-events': isDisable == 1 ? 'none' : 'auto',
                  }"
                >
                  <span class="newaddplusnackentryRechanges"
                    ><i class="fa fa-plus me-1"></i> Add Other Ledgers
                  </span>
                </a>
              </div>
            </div>
            ...
            <div class="InnerSubTotalBoxes mt-2">
              <table class="TableInnerSubtotal" width="100%">
                <tr>
                  ...
                  <td align="right">
                    ...
                    >{{ this.roundToTwoDecimalPlaces(this.total_amount) }}
                  </td>
                </tr>
                <tr>
                  <td align="left">
                    Taxes
                    <a href="javascript:void(0);" class="TableInnerInfo"
                      ><i class="fa fa-info"></i
                    ></a>
                  </td>
                  <td align="right">
                    <span class="font_sans">₹</span>
                    {{ this.roundToTwoDecimalPlaces(this.total_tax) }}
                  </td>
                </tr>
              </table>
              <table class="TableInnerGrandTotal" width="100%">
                <tr>
                  ...
                  <td align="right">
                    <span class="font_sans">₹</span
                    >{{ this.roundToTwoDecimalPlaces(this.grandTotal) }}
                  </td>
                </tr>
              </table>
            </div>
    ...
    <div class="NewBackentryBottomRechanges">
      <div class="NewBackentryBottomInnerRechanges">
        <div class="row align-items-center">
          <div class="col-lg-12">
            <ul
              v-if="!(this.fromMyVoucher && this.isTransfer == 1)"
              class="d-flex align-items-center justify-content-end"
            >
              <!-- <li>
                <button class="CancelDeleteVoucherButtonUI" @click="showDeleteModal">
                  <i class="fa fa-trash"></i> Delete Voucher
                </button>
              </li> -->
              <li>
                <!-- Case 1: Cancel mode, modified, and not a transfer -->
                <button
                  v-if="isModified && action === 'Cancel' && isTransfer == 0"
                ...
                <button
                  v-else-if="action === '' && !isModified && isTransfer == 1"
                  class="CancelDeleteVoucherButtonUI"
                  :disabled="isBtnDisable"
                ...
                <button
                  v-else-if="
                    (action === 'Alter' && isModified && isTransfer == 1) || (action === 'Alter' && isModified && isTransfer == -1)
                  "
                  class="CancelDeleteVoucherButtonUI"
                  :disabled="isBtnDisable"
                  @click="showCancelModal"
                ...
                <button
                  v-else-if="action === 'Alter' && isTransfer == 0"
                  class="CancelDeleteVoucherButtonUI"
                  :disabled="isBtnDisable"
                  @click="revertBack"
                >
                ...
                <button
                  v-else-if="
                    (action === '' && isTransfer == 0 && $route.params.voucher_id) || (action === '' && isTransfer == -1 && $route.params.voucher_id)
                  "
                  class="CancelDeleteVoucherButtonUI"
                  :disabled="isBtnDisable"
                  @click="revertBack"
              ...
              <li
                v-if="
                  ...
                  !isFutureDate &&
                  this.eInvoiceStatus == 'Yes'
                "
              >
                <button
                  class="CreateeInvoiceeWayButtonBottom d-none"
                  v-b-modal.customerstatus-popup
                >
                  Create eInvoice
                ...
                <button
                  @click="updateisTransferStatusForEinvoice"
                  class="CreateeInvoiceeWayButtonBottom"
                  :disabled="
                    button_einvoice_disabled === '1' ||
                    (isModified && action === 'Cancel' && isTransfer == 0)
                  "
                >
                  Create eInvoice
                  <span v-show="isLoadingeInvoice" class="SpinColorBlack"
                    ><i class="fa fa-spinner fa-spin"></i
                  ></span>
                </button>
              </li>
              <li v-if="EwayEinvoiceElligible && !isFutureDate">
                <button
                  class="CreateeInvoiceeWayButtonBottom d-none"
                  v-b-modal.customerstatus-popup
                >
              ...
              <li>
                <button
                  v-if="this.$route.params.voucher_id"
                  @click="update_sales"
                  class="CreateVoucherButtonBottomRechanges"
                  :disabled="
                    button_disabled === '1' ||
                    (isModified && action === 'Cancel' && isTransfer == 0) ||
                    isBtnDisable ||
    ...
    <b-modal
      ...
      class="CancelDeleteVoucherPopupMain"
      hide-footer
      hide-header
      centered
    >
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="DeleteCancelYesNoButton">
            <button
              class="ConfirmYesButton"
              @click="$bvModal.hide('DeleteVoucherModal')"
            >
              CONFIRM YES
            </button>
            <button class="NoButton" @click="deleteVoucherNo">No</button>
          </div>
        </div>
      </div>
    </b-modal>
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <div class="CancelCancelYesNoButton">
            ...
            <button class="NoButton" @click="cancelVoucherNo">No</button>
          </div>
        </div>
      </div>
    </b-modal>
                    ...
                    >
                      <b-carousel-slide caption="">
                        <div class="CarouselImageEWay">
                          <img
                            src="/assets/images/1.0/png/EWayFirstImage.png"
                            alt="image slot"
                          />
                        </div>
                      ...
                      <b-carousel-slide caption="">
                        <div class="CarouselImageEWay">
                          <img
                            src="/assets/images/1.0/png/EWaySecondImage.png"
                            alt="image slot"
                          />
                        </div>
                        <div class="slide-content">
                      ...
                      <b-carousel-slide caption="">
                        <div class="CarouselImageEWay">
                          <img
                            src="/assets/images/1.0/png/EWayThirdImage.png"
                            alt="image slot"
                          />
                        </div>
                        <div class="slide-content">
                      ...
                      <b-carousel-slide caption="">
                        <div class="CarouselImageEWay">
                          <img
                            src="/assets/images/1.0/png/EWayFourthImage.png"
                            alt="image slot"
                          />
                        </div>
                        <div class="slide-content">
                  ...
                  <div class="EWayLoginFormBox">
                    <div class="EWayLoginPopupForm position-relative mb-4">
                      ...
                      <input
                        ...
                        :disabled="true"
                      />
                      <span class="error-validation" v-if="gstinError"
                        >Invalid GSTIN format</span
                      >
                    </div>
                    <div class="EWayLoginPopupForm position-relative mb-4">
                    ...
                    <div class="EWayLoginPopupForm position-relative mb-4">
                      ...
                      <div class="input-wrapper-GSP-password">
                        <input
                          :type="passwordVisibleeWayLogin ? 'text' : 'password'"
                        ...
                        />
                        <span
                          class="eye-icon-gsp-password"
                          @click="togglePasswordVisibility"
                        >
                          <i
                            :class="
                              passwordVisibleeWayLogin
                                ? 'fa fa-eye'
                                : 'fa fa-eye-slash'
                            "
                          ></i>
                    ...
                    <div class="EWayLoginButton">
                      ...
                      >
                        LOGIN
                        <span v-show="isLoadingGsp" class="SpinColorWhite"
                          ><i class="fa fa-spinner fa-spin"></i
                        ></span>
                      </button>
                    </div>
    ...
    <b-modal
      id="eWayBillDetailsModal"
      size=""
      title="eWay Bill Details"
      hide-footer
      centered
      @hidden="onEWayModalHidden"
    >
      <div class="modal-content">
        <div class="row align-items-center">
          <div class="col-lg-4 col-12 mb-2">
            <div class="SupplyTypeRadioButton">
              <label
                class="eWayBillDetailsPopupLabel setWidthsupplytypewithdoctype"
                >Supply Type <span class="Validationspanerror">*</span></label
              >
              <div class="invoice_radio_button">
                <input
                  type="radio"
                  ...
                  autocomplete="off"
                />
                <label for="outwardRadio" class="fontssetlabelRechanges"
                  >Outward</label
                >
              </div>
              <div class="invoice_radio_button">
                <input
                  ...
                  autocomplete="off"
                />
                <label for="inwardRadio" class="fontssetlabelRechanges"
                  >Inward</label
                >
              </div>
            </div>
          ...
          <div class="col-lg-4 col-12 mb-2">
            <div class="eWayBillDetailsPopupDropdown">
              <label class="eWayBillDetailsPopupLabel setWidthsubtypedocno"
                >Sub Type <span class="Validationspanerror">*</span></label
              >
              <select
                v-model="SubSupplyTypeValue"
                @change="SupplyTypeChanged($event)"
              >
                <option disabled value="">Please Select</option>
                <option
                  v-for="(option, index) in subSupplyTypeData"
                  :key="index"
            ...
            <span
              class="error-validation"
              v-if="Eway_Error.subSupplyTypeData"
              >{{ Eway_Error.subSupplyTypeData }}</span
            >
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-4 col-12 mb-2">
            <div class="eWayBillDetailsPopupDropdown">
              <label
                class="eWayBillDetailsPopupLabel setWidthsupplytypewithdoctype"
                >Doc Type <span class="Validationspanerror">*</span></label
              >
              <select
                v-model="DocumentTypeValue"
                @change="DocumentCodeFunction($event)"
              >
                <option disabled value="">Please Select</option>
                <option
                  v-for="option in documentTypeData"
          ...
          <div class="col-lg-4 col-12 mb-2">
            <div class="eWayBillDetailsPopupInputDate">
              <label class="eWayBillDetailsPopupLabel setWidthttypewithdocdate"
                >Doc Date <span class="Validationspanerror">*</span></label
              >
              ...
              <div class="row align-items-center">
                <div v-if="isButtonChecked" class="col-lg-8 col-12 mb-3">
                  <div class="TransportDetailsInputtext SetDisplayLabelInput">
                    <label class="eWayBillDetailsPopupLabel"
                      >Transporter Name
                    </label>
                    <input
                      v-model="TransporterNameValueText"
                ...
                <div v-else class="col-lg-8 col-12 mb-3">
                  <div class="TransportDetailsDropdown SetDisplayLabelInput">
                    ...
                    <select
                      @focus="checkAvailablityFunc()"
                      v-model="TransporterNameValue"
                      @change="transporterNameselected()"
                    >
                      <option disabled value="">Enter Name</option>
                      <option
                        v-for="(option, index) in TransporterName"
                        :key="index"
                  ...
                  <span
                    class="error-validation"
                    v-if="Eway_Error.transporterName"
                    >{{ Eway_Error.transporterName }}</span
                  >
                </div>
                <div class="col-lg-4 col-12">
                  <div class="CheckBoxAddTransportDetailsinner">
                    <input
                      type="checkbox"
                      id="transporteridname"
                      @change="updateFlag()"
                    />
                    <label for="transporteridname">Enter Manually.</label>
                    <span
                      class="error-validation TransporterError"
                      v-if="Eway_Error.CheckTransporterName"
                ...
                <div v-if="isButtonChecked" class="col-lg-8 col-12 mb-3">
                  <div class="TransportDetailsInputtext SetDisplayLabelInput">
                    ...
                    <input
                      @input="validateTransporterID"
                      v-model="TransportIdValue"
                      placeholder="Enter details"
                    />
                  </div>
                  <span
                    class="error-validation"
                    v-if="Eway_Error.transporterId"
                    >{{ Eway_Error.transporterId }}</span
                  >
                </div>
                <div v-else class="col-lg-8 col-12 mb-3">
                  <div class="TransportDetailsDropdown SetDisplayLabelInput">
                    ...
                    <select
                      @change="transporterIdselected()"
                      v-model="TransportIdValue"
                    >
                      <option disabled value="">Please Select</option>
                      <option
                        v-for="(option, index) in TransporterId"
                        :key="index"
                ...
                <div class="col-lg-8 col-12 mb-3">
                  <div
                    class="TransportDetailsInputtext SetDisplayLabelInput"
                    v-if="showDistanceInput"
                  >
                    <label class="eWayBillDetailsPopupLabel"
                      >Approx Dist.(In KMs)</label
                    >
                    <input
                      type="text"
                  ...
                  <div class="AddDistancePlusClick" v-if="!showDistanceInput">
                    <button @click="OpenDistanceInput">
                      <img src="/assets/images/1.0/png/blueplus.png" /> Add
                      Distance
                    </button>
                  </div>
                </div>
            ...
            <div class="TransportDetailseWayBillPopup mb-1">
              ...
              <div class="row align-items-center">
                  ...
                  <div class="SupplyTypeRadioButton">
                    ...
                    <div class="invoice_radio_button">
                      <input
                        ...
                        name="radiomode"
                        value="Road"
                        v-model="TransportModeValue"
                        autocomplete="off"
                        @change="transportModeCode($event)"
                      />
                      <label for="RoadRadio" class="fontssetlabelRechanges"
                        >Road</label
                      >
                      <span
                        class="error-validation"
                        v-if="Eway_Error.TransportMode"
                        >{{ Eway_Error.TransportMode }}</span
                      >
                    </div>
                    <div class="invoice_radio_button">
                      <input
                        ...
                        @change="transportModeCode($event)"
                      />
                      <label for="RailRadio" class="fontssetlabelRechanges"
                        >Rail</label
                      >
                    </div>
                    <div class="invoice_radio_button">
                      <input
                        ...
                        @change="transportModeCode($event)"
                      />
                      <label for="AirRadio" class="fontssetlabelRechanges"
                        >Air</label
                      >
                    </div>
                    <div class="invoice_radio_button">
                      <input
                        ...
                        @change="transportModeCode($event)"
                      />
                      <label for="ShipRadio" class="fontssetlabelRechanges"
                        >Ship or Ship Cum Road/Rail</label
                      >
                    </div>
                  </div>
                </div>
                <div class="col-lg-12 col-12 mb-3">
                  <div class="SupplyTypeRadioButton">
                    ...
                    <div class="invoice_radio_button">
                      <input
                        @change="VehicleTypeModeCode($event)"
                        type="radio"
                        class="invoice_radio"
                        id="RegularRadio"
                        name="radiovehicle"
                        ...
                        autocomplete="off"
                      />
                      <label for="RegularRadio" class="fontssetlabelRechanges"
                        >Regular</label
                      >
                    </div>
                    <div class="invoice_radio_button">
                      <input
                        ...
                        autocomplete="off"
                      />
                      <label for="OverRadio" class="fontssetlabelRechanges"
              ...
              <div class="row align-items-center mt-1">
                <div class="col-lg-6 col-12 mb-2">
                  <div
                    class="eWayBillDetailsPopupInputText eWayBillDetailsPopupPartBDetailsInputText"
                  >
                    ...
                    <input
                      ...
                      @input="
                        vehicleNumberValue = vehicleNumberValue.toUpperCase()
                      "
                      v-on:keydown="disableArrowKeys"
                      v-on:wheel="disableMouseWheelScroll"
                    />
                  ...
                  <span
                    class="error-validation"
                    v-if="Eway_Error.vehicleNumberValue"
                    >{{ Eway_Error.vehicleNumberValue }}</span
                  >
                </div>
                <div class="col-lg-6 col-12 mb-2">
                  <div
                  ...
                  >
                    <label class="eWayBillDetailsPopupLabel"
                      >Transporter Doc. No</label
                    >
                    <input
                      v-model="TransportDocNumber"
                      type="text"
                      placeholder="Enter Doc No"
                      @keydown="handleKeyDown"
                      v-on:keydown="disableArrowKeys"
                      v-on:wheel="disableMouseWheelScroll"
                      @input="validateTransportDocNumber"
                    />
                  </div>
                  <span
                    class="error-validation"
                    v-if="Eway_Error.TransportDocno"
                    >{{ Eway_Error.TransportDocno }}</span
                  >
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-3 col-12">
              ...
              <div class="BillFromDispatchFrom mb-2">
                <label class="eWayBillDetailsPopupLabel setWidthBillFromLabel"
                  >Name
                </label>
                <input disabled v-model="DispatchName" />
              </div>
              <div class="BillFromDispatchFrom mb-2">
                <label class="eWayBillDetailsPopupLabel setWidthBillFromLabel"
                  >GSTIN</label
              ...
              <div class="BillFromDispatchFrom mb-2">
                <label class="eWayBillDetailsPopupLabel setWidthBillFromLabel"
                  >State</label
                >
                <select disabled v-model="BillFromStateName">
            ...
            <div class="col-lg-3 col-12">
              ...
              <div class="DispatchFromBoxDiv mb-2">
                <label
                  class="eWayBillDetailsPopupLabel setWidthDispatchFromLabel"
                  >Address
                </label>
                <textarea
              ...
              <div class="DispatchFromBoxDivPinState mb-2">
                <label
                  class="eWayBillDetailsPopupLabel setWidthDispatchFromLabel"
                  >Pin & State <span class="Validationspanerror">*</span></label
                >
                <input
                  v-model="DispatchPincode"
                  type="text"
                  placeholder="Enter"
                  @keydown="handleKeyDown"
                  @input="validateDispatchPincode"
                  v-on:keydown="disableArrowKeys"
                  v-on:wheel="disableMouseWheelScroll"
                />
              ...
              <span
                class="error-validation"
                v-if="dispatchpincoderror !== ''"
                >{{ dispatchpincoderror }}</span
              >
            </div>
            <div class="col-lg-3 col-12">
              <div class="TransportDetailseWaybillpopupHeading mb-3">
        ...
        <div
          class="ErrorTransporterPartBDetails"
          v-if="Eway_Error.BothFieldRequired"
        >
          <p>
            <i class="fa fa-exclamation-circle" aria-hidden="true"></i> Please
            add Transporter Details or Part B Details
          </p>
        </div>
        <div class="d-flex justify-content-center">
          <div class="CreateeWayBillButtonPopup text-center mt-2">
            <button
              :disabled="
                button_einvoice_disabled == '1' || isButton_TransporterId == '1'
              "
              v-if="this.EwayandEinvoice"
              @click="generateEwayandEinvoice"
              type="button"
              class=""
            >
              Create eWay & eInvoice
              <span v-show="isLoadingeWay" class="SpinColorWhite"
                ><i class="fa fa-spinner fa-spin"></i
              ></span>
            </button>
            <button
              v-else
              @click="updateisTransferStatus"
              type="button"
              class=""
              :disabled="isButton_TransporterId == '1'"
            >
              Create eWay Bill
              <span v-show="isLoadingeWay" class="SpinColorWhite"
                ><i class="fa fa-spinner fa-spin"></i
      ...
      <div
        v-if="showPopupForVoucherNumber"
        class="OverlapPopupOverlay"
        @click.self="closePopupForVoucherNumber"
      >
        <div class="OverlayPopupContent">
          <p v-if="ewayerrorMessageForVoucherNumber">{{ this.ewayerrorMessageForVoucherNumber }}</p>
          <button @click="closePopupForVoucherNumber" type="button">OK</button>
        </div>
      </div>
    <!-- eWay Bill Details Modal -->

    <!-- <div v-if="isLoadingeInvoice" class="loader-overlay-eInvoice">
          <div class="eWayeInvoiceCaption">
        <div class="loadereeInvoiceText"></div>
        <h5>Generating eInvoice...</h5>
      </div>
      </div> -->
    <div
      v-if="showEinvoicePopup"
      class="OverlapPopupOverlay"
      @click.self="closeEinvoiceErrorPopup"
    >
      <div class="OverlayPopupContent">
...
export default {
  ...
  data() {
    return {
      ...
      isLoadingGsp: false,
      showPopup: false,
      showPopupForVoucherNumber: false,
      showEinvoicePopup: false,
      ShowEway: false,
      ShowEwayEinvoice: false,
      ShowEinvoice: false,
      GspButton_disabled: "1",
      gstinError: false,
      ewayerrorMessage: "",
      einvoiceErrorMessage: "",
      buyerAddress: "",
      CheckTransporterName: "",
      DispatchName: "",
      consignee_address: "",
      TransporterNameValueText: "",
      TransporterCheck: false,
      addLedger_error: [],
      error_tax: [],
      vouchernumberError: {},
      PrefixError: "",
      ...
      custom_suffix: "",
      // Reference Type Dropdown
      referenceSearchQuery: "On Account",
      disabledBillDates: {
        // Disable all dates BEFORE today (i.e., past)
      ...
      disabledDates: {
        customPredictor: (date) => {
          ...
          checkDate.setHours(0, 0, 0, 0); // normalize the input date to midnight
      
          return checkDate > today; // block dates after today
        }
      },
      ...
      buyerregistrationOptions: [
        { value: 1, buyersregistrationlabel: "Composition" },
        { value: 2, buyersregistrationlabel: "Regular" },
        { value: 3, buyersregistrationlabel: "Consumer" },
        { value: 4, buyersregistrationlabel: "Unregistered" },
      ],
      buyerregistrationFilteredOptions: [],
  ...
  computed: {
    ...
    isFutureDate() {
      return moment(this.newinvoiceDate).isAfter(moment(), 'day');
    },
    addOnsStatus() {
      ...
      if (this.parentUserId !== undefined && this.parentUserId !== '' && this.parentUserId !== null) {
        if (this.ewayWritePermission && this.eInvoiceWritePermission) {
          return (
            ...
            this.isEwayStatus && this.addOnsStatus.includes("EWAY_EINVOICE")
          );
        }
      }
      else {
    ...
    //   if (this.$route.params.voucher_id !== undefined) {
    //     return this.custom_Voucher_number - 1;
    //   }
    //   else{
    //     return this.custom_Voucher_number
    //   }
    // },
  },
  created() { },
  watch: {
    ReferenceNumber(value) {
     if (value) {
       this.referenceNumberRequiredError = '';
     }
    },
    newReferenceDate(value) {
      if (value) {
        this.referenceNumberRequiredError = '';
      }
    },
    ...
    voucherSearchQuery(newVal) {
     if( !this.$route.query.voucherIdFromSalesOrder && !this.$route.query.voucherIdFromQuotation){
    ...
    //     if (this.$route.params.voucher_id !== undefined && newVal == oldVal) {
    //       this.custom_Voucher_number = newVal - 1;
    //     }
    //   },
    //   immediate: true,
    //  }
  ...
  methods: {
    clearReferenceNumber() {
      ...
      this.newReferenceDate = '';
    },
    revertBack() {
      if(this.voucherSyncId){
        GoogleAnalytics.Sales_Revert_Back_Voucher();
      }
      else{
        GoogleAnalytics.Sales_Delete_Voucher();
      }
  ...
  cancelVoucherNo() {
      ...
      if (this.buyerregistrationSearchQuery !== "Unregistered") {
        ...
        if (Type == "Buyer") {
          if (gstinRegex.test(this.BuyerGstin)) {
            this.VerifyGst("Buyer");
            this.advancedError["BuyerGdstin"] = "";
          } else {
    ...
    validateTransporterID() {
      ...
      if (transporterIdValidate.test(this.TransportIdValue)) {
        ...
        this.TransporterCheck = true;
        this.verifyTransporterId()
      }
      else {
        this.isButton_TransporterId = "1";
        this.TransporterCheck= false;
      ...
      if (value) {
        if (value.length > 6 || value.length < 6) {
          ...
          this.advancedError.BuyerPostalCode = "valid postal code is required";
           ...
           if(Type=="Buyer"){
             this.consigneePostalCode = this.BuyerPostalCode;
           }
           else if (Type=="Consignee"){
            this.BuyerPostalCode = this.consigneePostalCode;
           }
           this.button_disabled = "0";
    ...
    validateDispatchPincode() {
      this.dispatchpincoderror = "";
      const pincode = this.DispatchPincode.trim();

      // Example validation: must be exactly 6 digits and all numeric
      const isValid = /^\d{6}$/.test(pincode);

      if (!isValid) {
        this.isButton_TransporterId = "1"
        this.dispatchpincoderror = "Please Enter Valid Pincode Number";
        return;
      }
    ...
    validateWordLimit() {
      const wordLimit = 100;
      const words = this.narrationData
      if (words.length > wordLimit || words.length < 3) {
    ...
    closePopupForVoucherNumber(){
      this.showPopupForVoucherNumber = false;
    },
    ...
    // this function is to check user permission for eway and einvoice
    async getUserPermission() {
      ...
      try {
        ...
        console.log(responseDataa, "response data form permissiona pi")
    ...
    // this function is checking if transporter name is available or not.
    ...
    // this function is to disable eway and einvoice button.
    validation_einvoice() {
      this.button_einvoice_error = [];
      this.button_einvoice_disabled = "1";

      if (!this.AddNewItemList[0].tableitemsSearchQuery) {
        this.button_einvoice_error["table_items"] = "Table Items are required";
      }
      if (Object.keys(this.button_einvoice_error).length === 0) {
        this.button_einvoice_disabled = "0";
      }
    },
    ...
    GetCityByPincode() {
      ...
      Api.getCityByPincode(data, headers).then((response) => {
        ...
        if (response.data.message == "AUTHENTICATION_FAILED") {
          ...
          // if(response.data.data.city==""){
          //   this.dispatchpincoderror = "Invalid Pincode Number";
          //   this.isButton_TransporterId="1"
          // }
        }
      });
      ...
      Api.getInvoiceConfigurationsGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.invoice_type =
              CommonResponse.voucherNumberConfiguration.sales.isSetDefaultNumber;
            this.isEwayStatus = CommonResponse.isEwayStatus;
            this.customizeVoucherNumber =
              CommonResponse.voucherNumberConfiguration.sales.customizeVoucherNumber;
            ...
            if (this.$route.params.voucher_id !== undefined) {
              this.customizeVoucherNumber.isSalesNumber =
                Number(response.data.data.vouchers.voucherNumberConfiguration.sales.customizeVoucherNumber.number) - 1;
            }
            else {
              this.customizeVoucherNumber.isSalesNumber =
      ...
      const data = {
        ...
        voucherNumberConfiguration: {
          ...
          sales: {
            ...
            isSetDefaultNumber:
              this.selectedOptionradio == "default" ? this.invoice_type : false,
          },
          salesorder: {
            customizeVoucherNumber: {
      ...
      Api.getNextVoucherNumberGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            // this.custom_Voucher_number = this.voucherNumber
          } else {
            this.voucherNumber = "";
          }
        })
      ...
      try {
        ...
        for (let [key, value] of Object.entries(response.data.data.list)) {
          this.tableitemsOptions.push({
            ...
            itemrate: parseFloat(value.lastSalesPrice).toFixed(this.totalDecimalValueForRate),
    ...
    async getlocationlist() {
      try {
        ...
        if (response.data.message === "success") {
          // if (response.data.data.list.length == "1" && this.GodownSearch == "") {
          //   console.log("yes my length is 1")
      ...
      if (this.usePriceLevels == "Yes") {
        if (
          ...
          if (
            ...
            return { rateValue: givenRateListWithoutZero[0]["rateValue"], discountValue:  givenRateListWithoutZero[0]["discount"]};
          } else {
            if (givenRateListWithoutZero.length == 1) {
             return { rateValue: givenRateListWithoutZero[0]["discount"],  discountValue:  givenRateListWithoutZero[0]["discount"] };
            }
          }
          ...
          if (priceLevelList.length === 0) {
            ...
            for (let [priceLevelkey, priceLevel] of Object.entries(
              ...
              if (
                ...
                discountValue = priceLevel["discount"]
              } else if (
                parseFloat(priceLevel["startValue"]) === 0.0 &&
                parseFloat(priceLevel["endValue"]) !== 0.0 &&
            ...
            return {rateValue,discountValue };
          }
        } else {
          // getStandardRate
    ...
    other_gst_calculation() {
      ...
      Api.getGstDetails(data, headers).then((response) => {
        if (response.data.data.otherLedgerDetails.length != "0") {
          if (response.data.status != "0") {
            if (response.data.data.isGstApplicable == false && this.tableitemsSearchQuery == '') {
    ...
    getStandardRate(selection, index) {
      ...
      if (selection.standardSellingPriceList.length != "0") {
        ...
        if (priceLevelList.length == "0") {
          ...
          discountValue = priceLevelList[0]["discount"]
        }

        return {rateValue: rateValue,discountValue: discountValue};
      } else {
        //if no standard rate
        return this.getLastRate(selection, index);
      }
    ...
    getLastRate(selection, index) {
          const rate = selection.itemrate === "0"
        ? ""
        : parseFloat(selection.itemrate).toFixed(this.totalDecimalValueForRate);
    ...
    updateAmount(index) {
      ...
      if (item.itemdiscount) {
        item.itemamount = parseFloat(
          (itemAmount * (100 - discount)) / 100
        ).toFixed(this.totalDecimalValueForRate);
      } else {
        item.itemamount = parseFloat(itemAmount).toFixed(this.totalDecimalValueForRate);
      }
    ...
    new_rate(selection, index) {
      if (this.pricelevelSearchQuery) {
        if (this.AddNewItemList[index].selectedOption) {
         const { rateValue, discountValue } = this.getPriceAccordingPriceLevel(
        this.AddNewItemList[index].selectedOption,
        index
      );
      this.AddNewItemList[index].itemrate = parseFloat(rateValue).toFixed(
        this.totalDecimalValueForRate
      );
        this.AddNewItemList[index].itemdiscount = discountValue;
        }
      }
    },
    ...
    baseUnitNotApplicable(unitVal) {
      let baseUnitValue = "";
      if (unitVal == "#4; Not Applicable" || unitVal == undefined) {
        baseUnitValue = ""
      } else {
        baseUnitValue = unitVal
      }
      ...
      this.AddNewItemList.forEach((value, key) => {
        if (this.AddNewItemList[key].isChecked == true) {
          ...
          var inner_object = {
            ...
            itemRate: isNaN(itemRate)
              ? "0"
              : parseFloat(itemRate).toFixed(this.totalDecimalValueForRate).toString(),
            discountPercent: value.itemdiscount,
            isTaxInclusive: this.AddNewItemList[key].isChecked,
            gstPercent: "",
            serialNo: key + 1,
      ...
      if (this.item_object.length !== 0) {
        Api.getGstDetails(data, headers)
          .then((response) => {
              ...
              if (response.data.status != "0") {
                ...
                if (response.data.data.itemGstDetails.length != 0) {
                  response.data.data.itemGstDetails.forEach((value, key) => {
                    let baseUnitVal = this.baseUnitNotApplicable(this.AddNewItemList[key].baseUnits);
                    ...
                    if (response.data.data.igstApplicable == true) {
                      this.tempItmesObject.push({
                        ...
                        baseUnits: baseUnitVal,
                        rate:
                          parseFloat(this.AddNewItemList[key].itemrate).toFixed(this.totalDecimalValueForRate) +
                          (baseUnitVal ? `/${baseUnitVal}` : ``),
                        inclusiveVatRate: this.AddNewItemList[key].isChecked
                          ? parseFloat(
                            this.AddNewItemList[key].old_amount
                          ).toFixed(this.totalDecimalValueForRate) +
                          "/" +
                        ...
                        discount: this.AddNewItemList[key].itemdiscount.toString(),
                ...
                this.AddNewItemList.forEach((value, key) => {
                  ...
                  this.tempItmesObject.push({
                    ...
                    baseUnits: baseUnitVal,
                    inclusiveVatRate: this.AddNewItemList[key].isChecked
                      ? parseFloat(this.AddNewItemList[key].old_amount).toFixed(
                        this.totalDecimalValueForRate
                      ) +
                      "/" +
                      this.AddNewItemList[key].baseUnits
              ...
              this.AddNewItemList.forEach((value, key) => {
                ...
                this.tempItmesObject.push({
                  ...
                  billedQty:
                    ...
                    " " +
                    baseUnitVal,
                  stockItemName: stockitemNameRecheck,
                  amount: parseFloat(this.AddNewItemList[key].itemamount),
                  ledgerEntry: [],
                  hsnCode: this.AddNewItemList[key].hsn_code,
                  isIncGSTChecked: false,
            ...
            if (!this.EwayEinvoiceItemsarray[index]) {
              this.EwayEinvoiceItemsarray[index] = {};
            }
            response.data.data.itemGstDetails.forEach((value, key) => {
              this.EwayEinvoiceItemsarray[index].taxRate = parseFloat(
                value.gstPercent
              );
            });
          })
    ...
    add_Sales() {
      ...
      this.AddNewItemList.forEach((value, key) => {
        ...
        if (this.AddNewItemList[key].tableitemsSearchQuery == "" && this.AddNewItemList[key].itemrate != '') {
          this.stockItemsError["tableitemsSearchQuery"] =
            "Please select item.";
        }
        if (
          ...
          if (
            value.itemquantity == "" ||
            parseFloat(value.itemquantity) <= "0" || isNaN(Number(value.itemquantity))
          ) {
      ...
      //     this.dispatch_shipping_date != "" || this.dispatch_delivery_note != '' || this.dispatch_bill_no != '' || this.dispatch_despatch_through != '' || this.vehicleNumberValue != '' || this.dispatch_destination != '')
      // ) {
      ...
      if ((this.referenceSearchQuery == "New Reference" || this.referenceSearchQuery == "New Ref") && this.billNumberData == "") {
        this.advancedError["billNumberData"] = "Please Enter Bill Number";
        this.stockItemsError["billNumberData"] = "Please Enter Bill Number";
      }
      ...
      if (Object.keys(this.stockItemsError).length === 0) {
            ...
            billAllocationdetails: [
              {
                ...
                billCreditPeriod: "0",
                billDate: moment(String(this.newDueDate)).format("YYYY-MM-DD"),
                billId: "",
        ...
        if (index !== -1) {
          this.$set(this.final_ledgerEntries, index, newLedgerEntry);
        } else {
          if ((newLedgerEntry.ledgerGuid && newLedgerEntry.ledgerGuid !== "") || (newLedgerEntry.ledgerSyncId && newLedgerEntry.ledgerSyncId !== '')) {
        ...
        const data = {
          ...
          voucherDate: this.newinvoiceDate ? moment(String(this.newinvoiceDate)).format("YYYY-MM-DD"): moment(new Date()).format('YYYY-MM-DD'),
          ...
          narration: this.narrationData,
          isTransfer: 0,
          referenceDate: this.newReferenceDate !=="" && this.newReferenceDate !== null && this.newReferenceDate !== undefined ? moment(String(this.newReferenceDate)).format("YYYY-MM-DD") : "",
          ...
          eWayBillDetails: [
            {
              ...
              // isGenerate: 1, //- 1.only eway    2.only Envoice// not adding transporter to vehicle type  and     3.einvoice+eway    4.eway with IRN
              ...
              isIgst: this.add_igstApplicable,
              ...
              billNumber: this.ewayBillNumber,
              billDate: this.eWayBill_date,
            },
          ],
          dispatchFromDetails: {
            name: this.DispatchName,
            stateName: this.DispatchStateName,
            pinCode: this.DispatchPincode,
            place: this.DispatchPlace,
        ...
        Api.addMyVoucher(data, headers)
          .then((response) => {
            ...
            if (response.data.message == "AUTHENTICATION_FAILED") {
              ...
              if ((this.ShowEway == false || this.ShowEway == undefined) && (this.ShowEinvoice == false || this.ShowEinvoice == undefined
              )) {
                setTimeout(() => {
                  this.$router.push({ name: "My Vouchers" });
                }, 1000);
    ...
    get_Sales_data() {
      ...
      let api = ''
      if(this.$route.query.voucherIdFromSalesOrder){
        var data = {
        voucherId: this.$route.query.voucherIdFromSalesOrder,
        company_id: localStorage.getItem('companyId') ,
        _userId: localStorage.getItem('customerId'),
        requestFrom: "WEB"
      }
        api = 'getSalesOrdertoSales'
      }
      else if(this.$route.query.voucherIdFromQuotation){
        var data = {
        quotationId: this.$route.query.voucherIdFromQuotation,
        company_Id: localStorage.getItem('companyId') ,
        _userId: localStorage.getItem('customerId'),
        requestFrom: "WEB"
      }
       ...
       const isEdit = String(this.$route.query.isEdit) === '1';
        ...
        api = isEdit
          ? "getExistingVoucherDetails"
          : "getVoucherFullDetailsFromSyncGoo";
      ...
      Api[api](data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            // if(this.$route.query.voucherIdFromSalesOrder == undefined && this.$route.query.voucherIdFromQuotation == undefined){
            ...
            // }
            if (resData && resData.stockItemEntries && resData.stockItemEntries.length > 0) {
            this.ledgertypeSearchQuery = resData.stockItemEntries[0].ledgerName || "";
            } else {
            ...
            this.ReferenceNumber = resData.reference;
            this.newReferenceDate = resData.referenceDate;
            this.originalReferenceNumber = resData.reference;
            this.originalReferenceDate = resData.referenceDate;
          }
            ...
            (response) => {
              if (response.data.status != "0") {
                for (let [key, value] of Object.entries(
                  ...
                  if( this.$route.query.voucherIdFromSalesOrder || this.$route.query.voucherIdFromQuotation ){
                    let currentVoucherType = this.$route.query.voucherType
                    this.selectOption('voucher',{voucherTypeName: currentVoucherType})
                  }
                   if(this.partyGuid == value.guid){
                    this.isbillwise = value.isBillWise;
                  }
                }
              }
              //       this.stateDetails();
          ...
          setTimeout(() => {
            ...
            for (let [key1, value1] of Object.entries(
              ...
              if (
                value1.isMoreLedgerField.toString() == "1" &&
                ...
                value1.isMoreLedgerField = (value1.isMoreLedgerField).toString();
              ...
              if (value1.ledgerName == this.partynameSearchQuery) {
                if (
                  ...
                  this.newDueDate = value1.billAllocationdetails[0].billDate
                } else {
                  this.billNumberData = "";
                }
              }
            ...
            for (let [key, value] of Object.entries(
              ...
              if (
                value.isMoreLedgerField.toString()== "1" &&
          ...
          if (response.data.data.eWayBillDetails.length !== 0) {
            this.ewayBillNumber = response.data.data.eWayBillDetails[0].billNumber;
            this.eWayBill_date = response.data.data.eWayBillDetails[0].billDate;
          }
          ...
          // this.BuyerGuid = response.data.data.basicBuyerDetails.basicBuyerGuid ? response.data.data.basicBuyerDetails.basicBuyerGuid : '';

          this.VerifyGst("Buyer");

          this.buyerAddress = response.data.data.basicBuyerDetails.billToAddress;
          this.narrationData = response.data.data.narration;
          ...
          this.consignee_address = 
            response.data.data.
              basicConsigneeDetails.shipToAddress;
          // this.ConsigneeGuid = response.data.data.basicConsigneeDetails.basicConsigneeGuid ? response.data.data.basicConsigneeDetails.basicConsigneeGuid : '';    

          if (response.data.data.invoiceDelNotes.length > 0) {
            this.dispatch_delivery_note =
          ...
          this.vehicleNumberValue = response.data.data.basicShipVesselNo;
          this.dispatch_motor_vehicle_no = response.data.data.basicShipVesselNo;


          for (let [key, value] of Object.entries(response.data.data.stockItemEntries)) {
            console.log("value in loop", value)
            this.EwayEinvoiceItemsarray.push({
              hsnCode: value.hsnCode,
              guid: value.stockItemGuid,
              taxRate: value.taxes[0].ratePer
            })
          }
          ...
          if(response.data.data.invoiceOrders.length > 0){
            this.order_date = response.data.data.invoiceOrders[0].basicOrderDate ? moment(response.data.data.invoiceOrders[0].basicOrderDate).format("YYYY-MM-DD") : '';
    ...
    update_sales() {
      ...
      this.AddNewItemList.forEach((value, key) => {
        if (
          !this.AddNewItemList[0].tableitemsSearchQuery &&
          this.AddOtherLedgersListDropdown.length == 0 &&
          this.AddNewItemList.length == 1
        ) {
          this.service_error["otheritems"] =
            "Please Fill Either Item And Other Ledgers";
          this.stockItemsError["otheritems"] =
        ...
        if (this.AddOtherLedgersListDropdown !== null) {
          ...
          this.ledger_array.forEach((number1, key) => {
            ...
            this.add_more_ledger.push({
              ...
              ledgerGroup: number1.ledger_ledgerGroup,
              ledgerGroupParent: number1.ledger_ledgerGroupParent,
              amount: parseFloat(this.roundToTwoDecimalPlaces(amount)),
              billAllocationdetails: [],
              bankAllocationDetails: [],
              isGstApplicable: number1.isGstApplicable,
              hsnCode: number1.hsnCode,
        ...
        const apiCall = isEdit
          ...
          .then((response) => {
            if (response.data.message == "AUTHENTICATION_FAILED") {
              ...
              this.isBtnDisable = true;
              this.updateTimeVoucherId = response.data.data.id
              if (this.ShowEway == false && this.ShowEinvoice == false) {
                setTimeout(() => {
                  if (isEdit) {
                    this.handleRoute();
                  } else {
    ...
    ReferenceselectOption(option) {
      ...
      this.referenceActiveIndex = -1;
      if(this.isbillwise == true && (this.referenceSearchQuery == "New Reference" ||
          this.referenceSearchQuery == "New Ref"))
          {
            this.billNumberData = this.voucherNumber;
          }
    },
    ReferenceclearSearch() {
      this.referenceSearchQuery = "";
      this.ReferencefilterOptions();
      this.vouchernumberError["billNumberError"] = "";
    },
    ...
    AddNewItemClick() {
      this.AddNewItemList.push({
        ...
        GodownDropdownOpen: false,
        filteredGodowns: [],
        // Initialize with empty or specific value
      });
      this.itemSearch = "";
      this.getStockItemList();
      this.GodownSearch = "";
    ...
    toggleEdit() {
      this.ReferenceNumber = this.originalReferenceNumber;
      this.newReferenceDate = this.originalReferenceDate;
    ...
    saveEdit() {
      if(this.ReferenceNumber !== "" && this.newReferenceDate == ""){
        this.referenceNumberRequiredError = "Please Select Reference Date";
        return
      }
      if(this.ReferenceNumber == "" && this.newReferenceDate !== ""){
        this.referenceNumberRequiredError = "Please Select Reference Number";
        return
      }
      this.originalReferenceNumber = this.ReferenceNumber;
      this.originalReferenceDate = this.newReferenceDate;
    ...
    allowOnlyNumbers(event) {
      ...
      if (
        this.custom_Voucher_number &&
        this.custom_Voucher_number.toString().length >= 10
      ) {
        event.preventDefault();
        return;
      }
    ...
    toggleDropdown(dropdownType, open) {
      if (dropdownType == "partyname" && this.$route.query.voucherIdFromSalesOrder == undefined && this.$route.query.voucherIdFromQuotation == undefined ) {
        if(open){
    ...
    async filterOptions(dropdownType) {
      ...
      if (dropdownType === "voucher") {
        this.vouchertypeSearch = searchQuery;
        this.voucherOptions = []
    ...
    selectOption(dropdownType, option) {
      ...
      setTimeout(() => {
        ...
        this.partyDetails();
          ...
          this.partyDetails();
          this.isbillwise = option.isBillWise;
          ...
          this.buyerplaceofsupplySearchQuery = option.stateName;
    ...
    clearSearch(dropdownType) {
      if (dropdownType === 'voucher') {
        this.vouchertypeSearch = ''
        this.voucherFilteredOptions = []
        this.getVoucherType()
        setTimeout(() => {
          this.voucherFilteredOptions = [...this.voucherOptions]
        }, 500);
    ...
    selectGodown(option, index) {
      ...
      this.$nextTick(() => {
        const descriptioninput = this.$refs.descriptioninput[index];
        if (descriptioninput) {
    ...
    selectTableItemsOption(option, index) {
      this.$set(this, 'final_part_ledgerEntries', []);
      this.selectionDone = true
      if (this.usePriceLevels == "Yes") {
        this.AddNewItemList[index].itemquantity = 0;
      }
      const existingItemIndex = this.EwayEinvoiceItemsarray.findIndex(
        (item, idx) => idx === index
      );

      if (existingItemIndex !== -1) {
        this.EwayEinvoiceItemsarray[existingItemIndex] = {
      ...
      const { rateValue } = this.getPriceAccordingPriceLevel(option, index);
      const { discountValue = '0'  } = this.getPriceAccordingPriceLevel(option, index) || {};
      this.$set(
        this.AddNewItemList[index],
        "itemrate",
       parseFloat(rateValue).toFixed(this.totalDecimalValueForRate)
      );
      this.$set(this.AddNewItemList[index], 'itemdiscount',discountValue ? discountValue : '0')
      this.AddNewItemList[index].tableitemsSearchQuery =
        option.tableitemsSearchQuery;
    ...
    clearTableItemsSearch(datatype, index) {
      if (datatype == "Items") {
        ...
        this.$nextTick(() => {
          ...
          this.$nextTick(() => {
            if (
              this.$refs.tableitemsInput &&
              this.$refs.tableitemsInput[index]
            ) {
    ...
    toggleOtherLedgersDropdown(type,index, isOpen) {
      ...
      if (isOpen) {
        ...
        // Map options and mark already selected ones
    ...
    filterOtherLedgersOptions(event, index) {
      ...
      // Get all selected ledger names except the current index
      const selectedLedgers = this.AddOtherLedgersListDropdown
        .map((item, idx) => (idx !== index ? item.otherledgersSearchQueryDropdown : null))
        .filter(name => name); // Remove null values

      this.search = query;
      // Filter options based on search query but keep all visible
      const filteredOptions = this.otherledgers2Options.map(option => ({
        ...option,
    ...
    clearOtherLedgersSearch(index) {
      ...
      // Remove cleared ledger from selected list so it can be chosen again
      setTimeout(() => {
        const selectedLedgers = this.AddOtherLedgersListDropdown
          .map((item, idx) => (idx !== index ? item.otherledgersSearchQueryDropdown : null))
          .filter(name => name);
    ...
    toggleAddTaxesDropdown(index, isOpen) {
      const selectedTax = this.AddNewTaxesListDropdown
      .map((item, idx) => (idx !== index ? item.addtaxesSearchQuery : null))
        .filter(name => name); // Remove null values
        this.$set(
        ...
        setTimeout(() => {
          const filteredOptions = this.addtaxes3Options.map(option => ({
            ...option,
            isSelected: selectedTax.includes(option.ledgerName)
          })).filter(option => option.ledgerName.toLowerCase().includes(query));
      ...
      if (Object.keys(ledgerarray).length !== 0) {
        ...
        setTimeout(() => {
          ...
          this.final_part_ledgerEntries.push({
            ...
            amount: this.roundToTwoDecimalPlaces(amount_round),
          });
    ...
    clearAddTaxesSearch(index) {
      ...
      this.$set(
        this.AddNewTaxesListDropdown[index],
        "addtaxesFilteredOptions",
        this.addtaxes3Options.map(option => ({
          ...option,
          isSelected: selectedTax.includes(option.ledgerName) // Mark selected ones
        })).filter(option => option.ledgerName.toLowerCase()) // Only allow unselected ones
      );
    ...
    async AdvancedDroptoggleDropdown(dropdown, open) {
      ...
      if (open) {
        ...
        if (dropdown == "consigneestateDropdwonOpen") {
          await this.ConsigneestateDetails();
          this[filteredOptionsName] = this.stateData;
        }
    ...
    // this function is to seperately open the ewayeinvoice function.
    generateEwayandEinvoice() {
      this.updateisTransferStatusForEinvoice();
    },

    // function to check for login or to directly open the eway form
    checkLogin() {
      if (this.dispatch_motor_vehicle_no !== "") {
        this.vehicleNumberValue = this.dispatch_motor_vehicle_no;
      }
      this.advancedError = {};
      this.stockItemsError = {};
      this.errors = {};
      ...
      //   this.errors["dispatch_doc_no"] = "Dispatch doc no. required";
      // }
      if (this.dispatch_shipping_date == "" && (this.dispatch_doc_no != "" || this.dispatch_motor_vehicle_no != '')) {
        this.advancedError["dispatch_shipping_date"] =
          "Please Select Shipping Date.";
        this.stockItemsError["dispatch_shipping_date"] =
          "Please Select Shipping Date.";
      ...
      // if (this.BuyerGstin == "" && !this.partynameOptions[0].gstRegistrationType.toLowerCase().includes('unregistered')) {
      //   this.advancedError.BuyerGstin =
      //     "Buyer's GST number is mandatory for e-way/e-invoice.";
      //   this.errors.BuyerGstin =
      //     "Buyer's GST number is mandatory for e-way/e-invoice.";
      // }
      // if (this.consigneeGstin == "" && !this.partynameOptions[0].gstRegistrationType.toLowerCase().includes('unregistered')) {
      //   this.advancedError.consigneeGstin =
      //     "Consignee GST number is mandatory for e-way/e-invoice.";
      //   this.errors.consigneeGstin =
      //     "Consignee GST number is mandatory for e-way/e-invoice.";
      // }
      if (this.GstInvalid == true) {
        this.advancedError.BuyerGstin =
          "Invalid GST in Party. Please update the Gst in tally";
        this.errors.BuyerGstin =
          "Invalid GST in Party .Please update the Gst in tally";
      }
      if ((this.BuyerPostalCode == "" || this.consigneePostalCode=="") && this.BuyerGstin=="") {
        this.advancedError.BuyerGstin =
          "Please update Party Pincode to generate E-Way bill";
        this.errors.BuyerGstin =
          "Please update Party Pincode to generate E-Way bill";
      }
      if (Object.keys(this.errors).length === 0) {
       ...
       if(!VoucherNumberRegex.test(this.voucherNumber)){
         this.showPopupForVoucherNumber = true
         this.ewayerrorMessageForVoucherNumber = 'Incorrect voucher number format, please update'
       }
       else{
      ...
      GoogleAnalytics.eWayBill_Button();
      }
    },
    // this function is to generate eway & einvoices at the same time , i am making a flag true for that.
    OpenEwayandEinvoice() {
      if (this.dispatch_motor_vehicle_no !== "") {
        this.vehicleNumberValue = this.dispatch_motor_vehicle_no;
      }
      ...
      this.AddNewItemList.forEach((value, key) => {
        ...
        if (value.hsn_code.length < 6 && this.companyTurnOver >= 50000000) {
          this.stockItemsError['hsn_code'] = 'HSN Code Should not be less than 6 digits, please update.'
          this.errors['hsn_code'] = 'HSN Code Should not be less than 6 digits, please update.'
      ...
      if (this.BuyerGstin == "" && !this.buyerregistrationSearchQuery.toLowerCase().includes('unregistered')) {
        this.advancedError.BuyerGstin =
          "Buyer's GST number is mandatory for e-invoice.";
        this.errors.BuyerGstin =
          "Buyer's GST number is mandatory for e-invoice.";
      }
      if (this.consigneeGstin == "" && !this.buyerregistrationSearchQuery.toLowerCase().includes('unregistered')) {
        this.advancedError.consigneeGstin =
          "Consignee GST number is mandatory for e-invoice.";
        this.errors.consigneeGstin =
          "Consignee GST number is mandatory for e-invoice.";
      }
      if (this.GstInvalid == true) {
      ...
      // if (this.BuyerPostalCode == "" || this.consigneePostalCode=="") {
      //   this.advancedError.BuyerGstin =
      //     "Please update Party Pincode to generate E-Way bill";
      //   this.errors.BuyerGstin =
      //     "Please update Party Pincode to generate E-Way bill";
      ...
      Api.getGSTNumberDetails(data, headers)
        .then((response) => {
            if (
              ...
              response.data.data.gstSearchResponse.lgnm && this.TransporterCheck==true
            ) {
              this.isButton_TransporterId = "0"
    ...
    VerifyGst(Type) {
      const gstNumber = Type == "Buyer" ? this.BuyerGstin : this.consigneeGstin;

      // Don't call the API if GST number is empty
        ...
        .then((response) => {
            ...
            response.data.data.gstSearchResponse.pradr && response.data.data.gstSearchResponse.pradr.addr && response.data.data.gstSearchResponse.pradr.addr.pncd){
              if(this.BuyerPostalCode==""){
                this.BuyerPostalCode = response.data.data.gstSearchResponse.pradr.addr.pncd;
              }
              ...
              if(Type == "Buyer"){
                this.consigneeGstin = this.BuyerGstin;
              }
              else if(Type == "Consignee"){
                this.BuyerGstin = this.consigneeGstin;
              }
            }
            else{
    ...
    UpdateGSP() {
      ...
      console.log(this.isLoadingGsp, "isLoadingGsp");
    ...
    myVouchersPdfFOrEway() {
      if (this.onlyEway) {
        var data = {
          voucherId: this.VoucherIDValue ? this.VoucherIDValue : this.updateTimeVoucherId,
          company_id: localStorage.getItem("companyId"),
          _userId: localStorage.getItem("customerId"),
          requestFrom: "WEB",
          isEway: true,
    ...
    generateEway() {
      ...
      const data = {
        _userId: this.customerId ? this.customerId : '',
        mainUserId: this.parentUserId ? this.parentUserId : this.customerId,
        ewayCreatedBy: this.customerId ? this.customerId : '',
        isExisting: false,
        isStaging: this.ServerStatus == "Dev" ? true : false,
        _userId: localStorage.getItem("customerId"),
        company_id: localStorage.getItem("companyId"),
        ...
        supplyType: this.selectedSupply, //o - eway ---B2B --- einvoice
        subSupplyType: this.selectedCode,
        subSupplyDesc: this.selectedCode == "8" ? this.SubSupplyTypeValue : "",
        docType: this.selectedDocCode, //document type ka code ayega
        transactionType: 1,
        transporterId: this.TransportIdValue, //part A
        transporterName: this.TransporterNameValue
      ...
      Api.generateEway(data, headers)
        .then((response) => {
          if (response.data.message == "eway bill generated") {
            this.isLoadingeWay = false;
            let data = {
              _id: this.VoucherIDValue ? this.VoucherIDValue : this.updateTimeVoucherId,
              _userId: localStorage.getItem("customerId"),
              isTransfer: 0,
              requestFrom: "WEB",
            };
            ...
            this.isLoadingeWay = false;
            if (response.data.data[0].ErrorMessage !== undefined && response.data.data[0].ErrorMessage !== null) {
              this.ewayerrorMessage = response.data.data[0].ErrorMessage;
            }
            else {
              this.ewayerrorMessage = response.data.message;
            }
            this.showPopup = true;
            let data = {
              _id: this.VoucherIDValue ? this.VoucherIDValue : this.updateTimeVoucherId,
    ...
    generateEinvoice() {
      ...
      if (this.EwayandEinvoice) {
        var data = {
          isExisting: false,
          mainUserId: this.parentUserId ? this.parentUserId : this.customerId,
          eInvoiceCreatedBy: this.customerId ? this.customerId : '',
          isStaging: this.ServerStatus == "Dev" ? true : false,
          _userId: localStorage.getItem("customerId"),
          company_id: localStorage.getItem("companyId"),
          gstIn: localStorage.getItem("companyGstNumber"),
        ...
        .then((response) => {
          if (response.data.message == "eInvoice generated") {
            ...
            if (response.data.data[0].ErrorMessage !== undefined && response.data.data[0].ErrorMessage !== null) {
              ...
              this.einvoiceErrorMessage = response.data.message;
            }
      ...
      // }, 200);
      // }
      GoogleAnalytics.eInvoice_Button();
    },
    updateisTransferStatus() {
      this.Eway_Error = {};
   ...
   updateisTransferStatusForEinvoice() {
      if (this.EwayandEinvoice == false) {
        this.stockItemsError = {};
        this.advancedError = {};
        this.errors = {};
        this.error_tax = [];
        ...
        this.AddNewTaxesListDropdown.forEach((value, key) => {
          if (!value.addtaxesSearchQuery) {
            if (!this.error_tax.addtaxesSearchQuery) {
              this.error_tax.addtaxesSearchQuery = {};
            }
            this.stockItemsError["addtaxesSearchQuery"] =
              "Tax amount is required";
            this.error_tax.addtaxesSearchQuery[key] = "Tax is required";
            this.errors["addtaxesSearchQuery"] = "Tax amount is required";
          }
          if (value.amount == "") {
            if (!this.error_tax.amount) {
              this.error_tax.amount = {};
            }
            this.stockItemsError["amount"] = "Tax amount is required";
            this.error_tax.amount[key] = "Tax amount is required";
            this.errors["amount"] = "Tax amount is required";
        ...
        if (this.dispatch_shipping_date == "" && (this.dispatch_doc_no != "" || this.dispatch_motor_vehicle_no != '')) {
          ...
          this.stockItemsError["dispatch_shipping_date"] =
            "Please Select Shipping Date.";
          this.errors["dispatch_shipping_date"] =
            "Please Select Shipping Date.";
        }
         if (this.dispatch_delivery_note == "" &&  this.dispatch_shipping_date != '') {
        this.advancedError["dispatch_delivery_note"] =
    ...
    async getLedgerParentType(type) {
     ...
     cancelOrDeleteVoucher() {
      GoogleAnalytics.Sales_Cancel_Voucher();
      this.isBtnDisable = true;
  ...
  mounted() {
    ...
    this.getLedgerParentType('Sales Ledger');
    this.getLedgerParentType('Other Ledgers');
    this.getUserPermission()
    const voucherId = this.$route.params.voucher_id || this.$route.query.voucherIdFromSalesOrder || this.$route.query.voucherIdFromQuotation
    if (
    voucherId !== undefined
  ) {
      this.selectionDone = true
...
.eWayGSPPopupCaption h5 {
  font-size: 16px;
  margin-top: 20px;
  color: #fff;
}

.loader-overlay-eInvoice {
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
