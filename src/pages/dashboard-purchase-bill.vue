              ...
              <v-app id="inspire">
                ...
                >
                  <v-data-table
                    ...
                    :options.sync="options"
                    :items-per-page="
                      this.$store.state.Web1_Store.Purchase_Bill_itemsPerPage
                    "
                    :server-items-length="totalsalecustomer"
                    :loading="loading"
                    class="elevation-1"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      page: this.$store.state.Web1_Store.Purchase_Bill_page,
      totalsalecustomer: 0,
      numberOfPages: 0,
      salecustomer: [],
      value: [],
  ...
  watch: {
    ...
    "options.itemsPerPage"() {
      setTimeout(() => {
        const StartIndex =
          (this.$store.state.Web1_Store.Purchase_Bill_page - 1) *
          this.$store.state.Web1_Store.Purchase_Bill_itemsPerPage;
        const endIndex =
        ...
        if (Difference > this.totalsalecustomer) {
          ...
          this.page = this.$store.state.Web1_Store.Purchase_Bill_page;
          this.options.page = this.page;
        }
      }, 1000);
  ...
  computed: {
    currentPage() {
      return this.$store.state.Web1_Store.Purchase_Bill_page;
    },
  },
  methods: {
    freeusergeneratePdf() {
    ...
    StoredPage(newValue) {
      this.$store.dispatch("Web1_Store/setPurchaseBillPage", newValue.page);
    },
    updateItemsPerPage(newValue) {
      this.$store.dispatch("Web1_Store/setPurchaseBillItemsPerPage", newValue);
    },
    VoucherPdf(v_id) {
      const data = {
        requestFrom: "WEB",
