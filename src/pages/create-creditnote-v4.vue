        ...
        <div class="row">
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              ...
              <ul v-if="voucherDropdownOpen" class="SetScrollbarWidthSize">
                <li v-for="(option, index) in voucherFilteredOptions" :key="option.voucherTypeName" :data-id="option.id"
                  @mousedown="selectOption('voucher', option)" @click="selectOption('voucher', option)"
          ...
          <div class="col-lg-4 col-12 mb-2">
            <div class="VoucherNumberNewEntryRechanges">
              ...
              <div v-if="isEditing" class="editVoucherboxRechanges" v-click-outside="closeEvent">
                ...
                <div class="mt-3 border-top pt-3 pb-3">
                  ...
                  <!-- <div class="ReferencetypesearchRechanges">
                    ...
                    <input :disabled="isDisable" type="text" v-model="referenceSearchQuery"
                      @focus="ReferencetoggleDropdown(true)" @blur="ReferencetoggleDropdown(false)"
                      @input="ReferencefilterOptions" @keydown="handleReferenceKeydown" placeholder="Search..." 
                      ref="referenceInput" />
                    ...
                    <input class="mt-3" :disabled="isDisable" v-model="billNumberData"
                  ...
                  <div class="VoucherNumberReferenceTypePopupNewInput">
                    ...
                    <span class="borderlinetextdropdownRechanges">Original Invoice No.</span>
              ...
              <span class="borderlinetextdropdownRechanges">Date</span>
            ...
            <div class="OtherTypeSearchDropdownRechanges" >
              ...
              <input ref="pricelevelInput" type="text" v-model="pricelevelSearchQuery"
                ...
                @keydown.enter.prevent="selectActiveOption('pricelevel')" placeholder="Select Price Level"
                 />
              <button :disabled="isDisable" v-if="pricelevelSearchQuery" @click="clearSearch('pricelevel')" class="inputcrossiconRechanges">
                <i class="fa fa-times"></i>
              </button>
              <i v-else class="fa fa-search input-search-icon-Rechanges"></i>
              <ul v-if="pricelevelDropdownOpen" class="SetScrollbarWidthSize">
                <li  v-for="(option, index) in [{ priceLevelName: 'Not Applicable'}, ...pricelevelFilteredOptions]" :key="option.priceLevelName"
          ...
          <div class="col-lg-4 col-12 mb-2" v-if="isbillwise">
      ...
      <table width="100%" class="TableMiddleBackEntryRechanges">
        ...
        <tbody style="padding-bottom: 5px">
          <tr v-for="(addnewitem, index) in AddNewItemList" :key="addnewitem.id">
            ...
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
                ...
                <textarea class="textareatableinner" type="text" placeholder="Enter Notes"
                  ...
                  :disabled="button_disabled === '1' || isDisable " ref="descriptioninput"></textarea>
              </div>
            </td>
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
            ...
            <td class="text-center">
              <div class="ActionDeleteIconNewRechanges" :disabled="button_disabled === '1' || isDisable ">
          ...
          <div class="NarrationBoxesNewBackRechanges mb-2">
            ...
            <div v-if="isTextareaVisible" class="TextareaNarrationRechanges mt-2">
              <textarea ref="narrationInput" name="narration" v-model="narration" rows="1" placeholder="Enter Notes"
               :disabled="isDisable"  class="w-full" @input="validateWordLimit"></textarea>
            </div>
                            ...
                            " @input="
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  "
                          @keydown.enter.prevent="AdvancedselectActiveOption('buyersnameFilteredOptions', 'buyersnameActiveIndex', 'buyersnameSelectedOption', 'buyersnameSearchQuery', 'buyersnamelabel', 'buyercountryInput')"
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="Postal Code" @keydown="handleKeyDown"
                          ...
                          ref="postalcodeInput"  :disabled="isDisable"  @input="validatePostal($event)" />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="text" placeholder="GSTIN" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                          v-on:wheel="disableMouseWheelScroll" v-model="BuyerGstin" 
                          @input="validateGSTIN"  :disabled="isDisable" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                            ...
                            " @input="
                              ...
                              " @keydown.down.prevent="
                                ...
                                " @keydown.up.prevent="
                                  ...
                                  "
                          @keydown.enter.prevent="AdvancedselectActiveOption('consigneenameFilteredOptions', 'consigneenameActiveIndex', 'consigneenameSelectedOption', 'consigneenameSearchQuery', 'consigneenamelabel', 'consigneeGSTInput')"
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="Postal Code" @keydown="handleKeyDown"
                          ...
                          @input="validatePostal($event)"  :disabled="isDisable"/>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <Datepicker v-model="dispatch_shipping_date" format="dd MMM yyyy" placeholder="Select Date"
                          :disabled="isDisable" >
                        </Datepicker>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <Datepicker v-model="order_date" format="dd MMM yyyy" placeholder="Select Date"
                          >
                        </Datepicker>
                      ...
                      <div class="TaxesInputNewBackEntryRechanges">
                        <div class="ledgeramountwithdrdropdownRechanges position-relative">
                          ...
                          " v-model="addotherledgersDropdown.crdr"
                            :class="addotherledgersDropdown.crdr == 'CR' ? 'text-green' : 'text-red'"
                            >
            ...
            <div class="InnerSubTotalBoxes mt-2">
              <table class="TableInnerSubtotal" width="100%">
                <tr>
                  ...
                  <td align="right">
                    <span class="font_sans">₹</span>{{ this.roundToTwoDecimalPlaces(this.total_amount) }}
                  </td>
                </tr>
                <tr>
                  <td align="left">
              ...
              <table class="TableInnerGrandTotal" width="100%">
                <tr>
                  ...
                  <td align="right">
                    <span class="font_sans">₹</span>{{ this.roundToTwoDecimalPlaces(this.grandTotal) }}
                  </td>
                </tr>
              </table>
            </div>
            ...
            <ul v-if="!(this.fromMyVoucher && this.isTransfer == 1)" class="d-flex align-items-center justify-content-end">
              ...
              <li>
                <button v-if="this.$route.params.voucher_id" @click="update_sales"
                  class="CreateVoucherButtonBottomRechanges" :disabled="button_disabled === '1' || isDisable || (isModified && action === 'Cancel' && isTransfer == 0) || isBtnDisable || isGstCalculated">
                  Update Voucher
                </button>
                ...
                <div class="col-lg-6 col-12">
                  <div class="EWayLoginFormBox">
                    <div class="EWayLoginPopupForm position-relative mb-4">
                      ...
                      <input  :disabled="isDisable" type="text" v-model="gstinneweWay" placeholder="" @keydown="handleKeyDown"
                        v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll"
                    ...
                    <div class="EWayLoginPopupForm position-relative mb-4">
                      ...
                      <input  :disabled="isDisable" type="text" v-model="usernameValue" placeholder="" @keydown="handleKeyDown"
                        v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll"
                        @input="checkLoginButtonState" />
                    </div>
                    ...
                    <div class="EWayLoginPopupForm position-relative mb-4">
                      ...
                      <div class="input-wrapper-GSP-password">
                        <input  :disabled="isDisable" :type="passwordVisibleeWayLogin ? 'text' : 'password'" v-model="passwordValue"
        ...
        <div class="modal-body text-center">
          <div class="HeaderPortionTextDelete">
            <div class="DeleteCaptionHeaderHeading">
              <h5>Delete this Voucher {{ voucherNumber }}</h5>
            </div>
          ...
          <div class="DeleteCancelYesNoButton">
            <button class="ConfirmYesButton" @click="revertBack">
              CONFIRM YES
            </button>
...
export default {
  ...
  computed: {
    ...
    EwayEinvoiceElligible() {
      console.log("companyGstNumber:", this.companyGstNumber);
      console.log("parentUserId:", this.parentUserId);
      console.log("isEwayStatus:", this.isEwayStatus);
      ...
      return (
        ...
        (this.customerStatus == "Installation Done" ||
          this.customerStatus == "Churned" ||
          this.customerStatus == "Converted" ||
          this.customerStatus == "Converted Churned")
      );
    },
    VoucherEditable() {
  ...
  methods: {
    ...
    revertBack() {
      if(this.voucherSyncId){
        GoogleAnalytics.CreditNote_Revert_Back_Voucher();
      }
      else{
        GoogleAnalytics.CreditNote_Delete_Voucher();
      }
        const data = {
      ...
      Api.getInvoiceConfigurationsGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.invoice_type =
              CommonResponse.voucherNumberConfiguration.creditnote.isSetDefaultNumber;
            this.isEwayStatus = CommonResponse.isEwayStatus;
            this.customizeVoucherNumber =
              CommonResponse.voucherNumberConfiguration.creditnote.customizeVoucherNumber;
            ...
            if (this.$route.params.voucher_id !== undefined) {
              this.customizeVoucherNumber.isCreditNoteNumber =
                Number(response.data.data.vouchers.voucherNumberConfiguration.creditnote.customizeVoucherNumber.number) - 1;
            }
            else {
              this.customizeVoucherNumber.isCreditNoteNumber =
    ...
    getVoucherNumber() {
      ...
      if (this.VoucherEditable && this.voucherEditted) {
        this.combinedVoucherNumber = this.custom_prefix + this.custom_Voucher_number + this.custom_suffix
      }
      this.loading = true;
      ...
      const data = {
        ...
        ...(this.combinedVoucherNumber ? { voucherNumber: this.combinedVoucherNumber } : {})
      };
      const headers = {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json",
    ...
    other_gst_calculation() {
      ...
      this.AddNewItemList.forEach((value, key) => {
        if (this.AddNewItemList[key].isChecked == true) {
          const itemRate = value.itemrate * (1 + (this.AddNewItemList[key].gst_per / 100));
          var inner_object = {
            ...
            itemRate: isNaN(itemRate) ? "0" : parseFloat(itemRate).toFixed(this.totalDecimalValueForRate),
                ...
                if (response.data.data.igstApplicable == false) {
                 ...
                 this.ledger_array[key].gstAppropraiteTo = value.gstAppropraiteTo
                  ...
                  this.final_ledgerEntries.forEach((value, key) => {
                    if (value.ledgerName == this.AddNewTaxesListDropdown[0].addtaxesSearchQuery) {
                      this.final_ledgerEntries[key].amount = -parseFloat((response.data.data.voucherGstDetails.gstAmount / 2).toFixed(this.totalDecimalValueForRate));
                    }
                    if (value.ledgerName == this.AddNewTaxesListDropdown[1].addtaxesSearchQuery) {
                      this.final_ledgerEntries[key].amount = -parseFloat((response.data.data.voucherGstDetails.gstAmount / 2).toFixed(this.totalDecimalValueForRate));
                    }
                  });
                  this.AddNewTaxesListDropdown[0].amount = parseFloat(response.data.data.voucherGstDetails.gstAmount / 2).toFixed(this.totalDecimalValueForRate);
                  this.AddNewTaxesListDropdown[1].amount = parseFloat(response.data.data.voucherGstDetails.gstAmount / 2).toFixed(this.totalDecimalValueForRate);
                  this.total_tax += this.AddNewTaxesListDropdown[0].amount + this.AddNewTaxesListDropdown[1].amount;
                } else {
                  let otherLedgerDetails = response.data.data.otherLedgerDetails
                 otherLedgerDetails.forEach((value, key)=>{
                 this.ledger_array[key].isGstApplicable = value.isGstApplicable
                 ...
                 this.ledger_array[key].gstAppropraiteTo = value.gstAppropraiteTo
                  ...
                  this.final_ledgerEntries.forEach((value, key) => {
                    if (value.ledgerName == this.AddNewTaxesListDropdown[0].addtaxesSearchQuery) {
                      this.final_ledgerEntries[key].amount = -this.roundToTwoDecimalPlaces(response.data.data.voucherGstDetails.gstAmount);
                    }
                  });
                  this.AddNewTaxesListDropdown[0].amount = parseFloat(response.data.data.voucherGstDetails.gstAmount).toFixed(this.totalDecimalValueForRate);
    ...
    get_Sales_data() {
      ...
      apiCall(data, headers)
        .then((response) => {
          ...
          this.consigneeGstin = response.data.data.basicConsigneeDetails.shipToGSTIN;
    ...
    update_sales() {
      ...
      if (Object.keys(this.stockItemsError).length === 0) {
        let newLedgerEntry;
        if (this.referenceSearchQuery == "New Reference" || this.referenceSearchQuery == "New Ref") {
          newLedgerEntry = {
            ledgerGroupParent: this.ledgerGroupParent,
            ledgerName: this.partynameSearchQuery,
            ledgerGuid: this.partyGuid,
    ...
    saveEdit() {
      if(this.ReferenceNumber !== "" && this.newReferenceDate == ""){
        this.referenceNumberRequiredError = "Please Select Original Date";
        return
      }
      if(this.ReferenceNumber == "" && this.newReferenceDate !== ""){
        this.referenceNumberRequiredError = "Please Select Original Number";
        return
      }
    ...
    async getLedgerParentType(type) {
     ...
     cancelOrDeleteVoucher() {
      GoogleAnalytics.CreditNote_Cancel_Voucher()
  ...
  mounted() {
    ...
    this.getLedgerParentType('Ledger Account');
    this.getLedgerParentType('Other Ledger');
    if (this.$route.params.voucher_id !== undefined) {
