            ...
            <div class="row align-items-center">
                <div class="col-lg-12 col-12">
                    <div class="title_text">
                        <h4 class="page-title mb-0">Sales Order</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="company_name sales_c_name padding_left_30">
                                ...
                                <div class="company_balance sales_cb">
                                    <p>Total Sales Order: <strong><span class="font_sans">₹</span> 24,493.98</strong></p>
                                </div>
                            </div>
                                    ...
                                    <template v-slot:item.vouchernumber="{ item }">
                                        <td>
                                            <router-link class="onclick_details"
                                                :to="{name:'sales-order-ledger-details' }">999</router-link>
                                        </td>
                                    </template>
