...
export default {
  ...
  data() {
    ...
    return {
      ...
      headers: [
        ...
        { text: "Avg.Rate", value: "lastPrice", align: "right" },
      ],
      search: "",
      sortBy: "name",
      orderBy: null,
  ...
  watch: {
    ...
    page: function () {
      ...
      GoogleAnalytics.parties_sold_screen_pagination(this.options.page);
    },
    ...
    "options.itemsPerPage"() {
      ...
      if (this.call_function == "1") {
        ...
        GoogleAnalytics.parties_sold_screen_Rows_Per_Page(
    ...
    options: {
      handler() {
        ...
        GoogleAnalytics.parties_sold_listing();
      },
    },
    deep: true,
  },
  ...
  methods: {
    ...
    freeusergeneratePdf() {
      GoogleAnalytics.parties_sold_screen_viewpdf("viewpdf");
    },
    ...
    activatedate: function (date) {
      if (date === "oned") {
        // one day
        GoogleAnalytics.parties_sold_screen_date_filter("1D");
        ...
        // one week
        GoogleAnalytics.parties_sold_screen_date_filter("1W");
        ...
        // one month
        GoogleAnalytics.parties_sold_screen_date_filter("1M");
        ...
        // 3 month
        GoogleAnalytics.parties_sold_screen_date_filter("3M");
        var new_date_start_date = moment(String(new Date()))
          .add(-3, "M")
          .format("yyyy-MM-DD");
        var new_date_end_date = moment(String(new Date())).format("yyyy-MM-DD");
        ...
        // 1 Year
        GoogleAnalytics.parties_sold_screen_date_filter("1Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // 2 Year
        GoogleAnalytics.parties_sold_screen_date_filter("2Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // max date
        GoogleAnalytics.parties_sold_screen_date_filter("Max");
        var new_date_start_date = moment(
    ...
    update() {
      ...
      GoogleAnalytics.parties_sold_screen_date_filter("Custom");
      this.getpartyDetails("", this.groupSelectValue, this.switch_type);
      this.date_setting();
    },
    date_setting() {
    ...
    handleBlur() {
      const type = "search";
      GoogleAnalytics.parties_sold_screen_search(this.search);
    ...
    updateSort(byDesc, event) {
      ...
      GoogleAnalytics.parties_sold_screen_sorting(this.sortBy, this.orderBy);
