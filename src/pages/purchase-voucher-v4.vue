          ...
          <!-- <div class="col-lg-4 col-12 mb-2" v-if="usePriceLevels == 'Yes'">
            <div class="OtherTypeSearchDropdownRechanges" >
              ...
              <ul v-if="pricelevelDropdownOpen" class="SetScrollbarWidthSize">
                <li v-for="(option, index) in pricelevelFilteredOptions" :key="option.priceLevelName" :data-id="option.name"
                  @mousedown="selectOption('pricelevel', option)" @click="selectOption('pricelevel', option)"
                  ...
                  @input="filterTableItemsOptions('Items', $event, index)" @keydown.down.prevent="
                    ...
                    " @keydown.up.prevent="
                      ...
                      " @keydown.enter.prevent="
                        ...
                        " placeholder="Search Item" :disabled="isDisable"  />
                <button v-if="AddNewItemList[index].tableitemsSearchQuery"
                  @click="clearTableItemsSearch('Items', index)" class="inputcrossiconRechangesTableitems"
                  :disabled="isDisable">
                  <i class="fa fa-times"></i>
                </button>
        ...
        <div class="col-lg-7 col-12">
          <div class="NarrationBoxesNewBackRechanges mb-2">
            ...
            <div v-if="isTextareaVisible" class="TextareaNarrationRechanges mt-2">
              <textarea ref="narrationInput" name="narration" rows="1" placeholder="Enter Notes" v-model="narration"
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="Postal Code" @keydown="handleKeyDown"
                          ...
                          ref="postalcodeInput"  @input="validatePostal($event)" :disabled="isDisable" />
                      </div>
                    </div>
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input :disabled="isDisable" type="text" v-model="dispatch_motor_vehicle_no"
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input :disabled="isDisable" type="text" v-model="order_terms_of_payment" placeholder=""
                           />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input :disabled="isDisable" type="text" v-model="order_other_reference" placeholder=""  />
                      </div>
                    </div>
                    <div class="col-lg-6 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                      ...
                      <div class="TaxSelectoptionDropdownRechanges">
                        <div class="OtherwithTaxesserachableDropdownRechanges">
                          ...
                          <button v-if="addnewtaxesDropdown.addtaxesSearchQuery" @click="clearAddTaxesSearch(index)"
                            class="inputcrossicontaxesRechanges" :disabled="isDisable">
                            <i class="fa fa-times"></i>
                          </button>
                          ...
                          <ul v-if="addnewtaxesDropdown.addtaxesDropdownOpen" class="SetScrollbarWidthSize">
                            <li v-for="(
                              option, optionIndex
                                ...
                                addnewtaxesDropdown.addtaxesActiveIndex
                                " @mousedown="!option.isSelected && selectAddTaxesOption(option, index)">
        ...
        <div class="row align-items-center">
          <div class="col-lg-12">
            <ul v-if="!(this.fromMyVoucher && this.isTransfer == 1)" class="d-flex align-items-center justify-content-end">
              ...
              <li>
                <button v-if="this.$route.params.voucher_id" @click="update_Purchase"
                ...
                <button v-else @click="add_purchase" class="CreateVoucherButtonBottomRechanges"
                  :disabled="button_disabled === '1' || isDisable">
                  Create Voucher
                </button>
              </li>
  ...
  methods: {
    ...
    revertBack() {
       if(this.voucherSyncId){
        GoogleAnalytics.Purchase_Revert_Back_Voucher();
      }
      else{
        GoogleAnalytics.Purchase_Delete_Voucher();
      }
        const data = {
      ...
      Api.getInvoiceConfigurationsGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.invoice_type =
              CommonResponse.voucherNumberConfiguration.purchase.isSetDefaultNumber;
            this.isEwayStatus = CommonResponse.isEwayStatus;
            this.customizeVoucherNumber =
              CommonResponse.voucherNumberConfiguration.purchase.customizeVoucherNumber;
            ...
            if (this.$route.params.voucher_id !== undefined) {
              this.customizeVoucherNumber.isPurchaseNumber =
                Number(response.data.data.vouchers.voucherNumberConfiguration.purchase.customizeVoucherNumber.number) - 1;
            }
            else {
              this.customizeVoucherNumber.isPurchaseNumber =
   ...
   AmountChangeFunction(index){
    ...
    add_purchase() {
      ...
      this.AddNewItemList.forEach((value, key) => {
        ...
        else if (value.tableitemsSearchQuery == '' && (value.itemquantity || value.itemrate || value.itemdiscount)) {
          this.stockItemsError['tableitemsSearchQuery'] = "Select any item"
        }
        if (
          ...
          setTimeout(() => {
            ...
            for (let [key, value] of Object.entries(
              ...
              if (
                ...
                if (amount >= 0) {
                  // + value using same sign because we are getting the same sign in cr and dr when the oppsite sign are adding in the ledgermaount
    ...
    selectTableItemsOption(option, index) {
      ...
      this.AddNewItemList[index].itemrate = option.itemrate.toString()
      this.AddNewItemList[index].tableitemsSearchQuery =
        option.tableitemsSearchQuery;
    ...
    //to handle both items and godown
    selectTableItemsActiveOption(
      datatype,
      index,
      optionsField,
    ...
    async getLedgerParentType(type) {
     ...
     cancelOrDeleteVoucher() {
      GoogleAnalytics.Purchase_Cancel_Voucher();
