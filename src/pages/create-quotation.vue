      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-6 col-6">
          <div class="title_text" v-if="this.$route.params.voucher_id">
            ...
            <div v-else>
              <h4 class="page-title mb-0">Update Quotation</h4>
            </div>
          </div>
          <div class="title_text" v-else>
            <h4 class="page-title mb-0">Create Quotation</h4>
          </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="buyerdetails" role="tabpanel" aria-labelledby="buyerdetails-tab">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="form-group input_new_textbox mb-4">
                                <input type="text" :disabled="isTransfer == '1'" placeholder="Place of Supply"
...
export default {
  ...
  methods: {
    ...
    taxInclusive_calculation(event,index,lebel){
      if(lebel == "update"){
        var isChecked = this.tableRows[index].taxInclusiveChecked;
   ...
   disableArrowKeys: function (e) {
    ...
    gst_calculation(index) {
      ...
      // alert(Object.keys(this.filterItemDetails(this.item_object)).length);
                  ...
                  if (response.data.data.igstApplicable == true) {
                    ...
                    this.final_object.push({
                      ...
                      rate:
                        ...
                        (this.tableRows[key].baseUnits === "#4; Not Applicable" ? "" : "/" + this.tableRows[key].baseUnits),
      ...
      Api.getQuotationGo(data, headers)
        .then((response) => {
         ...
         this.consigneestateDetails()
          ...
          this.order_details_address = response.data.data.basicOrderTerms;
...
,
    ...
    async check_gst_calculation() {
      ...
      // Check if the currently selected company has a GST number
      if (companyGSTIn !== "") {
        ...
        if (!this.gstApplicable.replace("#4;", "").toLowerCase().includes("not applicable") && this.rateLists.length === 0) {
          if (this.item_rateLists !== null && this.item_rateLists.length > 0 && !this.item_gstApplicable.replace("#4;", "").toLowerCase().includes("not applicable")) {
            ...
            if (applicableGstRateList.calculationType === "On Value") {
              ...
              // Get price from the range of value
  ...
  mounted() {
    GoogleAnalytics.create_quotation_listing();
