              ...
              <div v-if="isEditing" class="editVoucherboxRechanges" v-click-outside="closeEvent">
                ...
                <div v-if="VoucherEditable" class="custominputboxnewentryradioRechanges">
                  ...
                  <div class="onlyinputcustomradioRechanges">
                    <input type="text" :disabled="isDefaultSelectedn || isDisable" placeholder="Prefix"
                      class="form-control me-2" @input="validateInput" v-model="custom_prefix" />
                    <input type="number" :disabled="isDefaultSelectedn || isDisable" placeholder="Voucher no"
                      class="form-control me-2" v-model="custom_Voucher_number" @keypress="allowOnlyNumbers" />

                    <input type="text" :disabled="isDefaultSelectedn || isDisable" placeholder="Suffix"
                      class="form-control" v-model="custom_suffix" />
                  </div>
                </div>
            ...
            <div class="OtherTypeSearchDropdownRechanges">
              ...
              <input ref="pricelevelInput" type="text" v-model="pricelevelSearchQuery"
                ...
                @keydown.enter.prevent="selectActiveOption('pricelevel')" placeholder="Select Price Level"
                 />
              <button :disabled="isDisable"  v-if="pricelevelSearchQuery" @click="clearSearch('pricelevel')"
                class="inputcrossiconRechanges">
                <i class="fa fa-times"></i>
              </button>
              <i v-else class="fa fa-search input-search-icon-Rechanges"></i>
        ...
        <thead style="padding-bottom: 5px">
          <tr>
            ...
            <th width="6%" style="text-align: center">
              <button class="NewItemNewBackEtryRechanges" :disabled="isDisable" @click="AddNewItemClick" >
            ...
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
                ...
                <textarea class="textareatableinner" type="text" placeholder="Enter Notes"
                  ...
                  :disabled="button_disabled === '1' || isDisable " ref="descriptionInputs"></textarea>
              </div>
              <span class="error-validation" v-if="
                isWordLimitExceededForDescription
              "> Word limit exceeded! Maximum 100 words allowed.</span>
            </td>
            <td class="text-center">
              <div class="InnerTableBackEntrytdDivRechanges">
...
option, index
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input type="number" placeholder="Postal Code" @keydown="handleKeyDown"
                          v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll"
                          v-model="consigneePostalCode" ref="consigneePostalcodeInput" :disabled="isDisable"
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                      <div class="AdvancedSettingInputRechanges position-relative">
                        ...
                        <input :disabled="isDisable" type="number" placeholder="" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                          v-on:wheel="disableMouseWheelScroll"  v-model="ewaybillNumber" />
                      </div>
                    </div>
          ...
          <div class="col-lg-12">
            <ul v-if="!(this.fromMyVoucher && this.isTransfer == 1)" class="d-flex align-items-center justify-content-end">
              <!-- <li v-if="EwayEinvoiceElligible">
                ...
                <button @click="generateEinvoice" class="CreateeInvoiceeWayButtonBottom" :disabled="button_disabled === '1'">
                  Create eInvoice
                </button>
              </li>
              <li v-if="EwayEinvoiceElligible">
                ...
                <button :disabled="button_disabled === '1'" class="CreateeInvoiceeWayButtonBottom" @click="checkLogin">
                  Create eWay
                </button>
              </li> -->
               <li>
        ...
        <div class="row align-items-center">
          <div class="col-lg-4 col-12 mb-2">
            <div class="SupplyTypeRadioButton">
              ...
              <div class="invoice_radio_button">
                <input :disabled="isDisable" type="radio" class="invoice_radio" id="outwardRadio" name="radioGroup" value="Outward"
                  v-model="RadioValue" autocomplete="off" />
                <label for="outwardRadio" class="fontssetlabelRechanges">Outward</label>
              </div>
              <div class="invoice_radio_button">
                <input :disabled="isDisable" type="radio" class="invoice_radio" id="inwardRadio" name="radioGroup" value="inward"
                  v-model="RadioValue" autocomplete="off" />
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4 col-12 mb-2">
            <div class="eWayBillDetailsPopupInputText">
              ...
              <input :disabled="isDisable" disabled v-model="this.voucherNumber" type="text" placeholder="Enter Number"
                @keydown="handleKeyDown" v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
            </div>
        ...
        <div class="TransportDetailseWayBillPopup">
          ...
          <div class="row align-items-center">
            <div class="CheckBoxAddTransportDetailsinner">
              ...
              <input :disabled="isDisable" type="checkbox" id="transporteridname" @change="updateFlag()" />
            </div>
            <div v-if="isButtonChecked" class="col-lg-4 col-12 mb-3">
              <div class="TransportDetailsInputtext">
                ...
                <input :disabled="isDisable" v-model="TransporterNameValueText" placeholder="Enter details" />
              </div>
            </div>
            ...
            <div v-if="isButtonChecked" class="col-lg-4 col-12 mb-3">
              <div class="TransportDetailsInputtext">
                ...
                <input :disabled="isDisable" v-model="TransportIdValue" placeholder="Enter details" />
              </div>
            ...
            <div class="col-lg-4 col-12 mb-3">
              <div class="TransportDetailsInputtext">
                ...
                <input :disabled="isDisable" type="text" placeholder="Enter Distance" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                  v-on:wheel="disableMouseWheelScroll" />
              </div>
            </div>
            <!-- <div class="col-lg-4 col-12 mb-3">
              <span>I want to enter details manually</span>
              <input :disabled="isDisable" type="checkbox" />
            </div> -->
          </div>
        </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-12 mb-2">
              <div class="SupplyTypeRadioButton">
                ...
                <div class="invoice_radio_button">
                  <input :disabled="isDisable" type="radio" class="invoice_radio" id="RoadRadio" name="radiomode" value="Road"
                ...
                <div class="invoice_radio_button">
                  <input :disabled="isDisable" type="radio" class="invoice_radio" id="RailRadio" name="radiomode" value="Rail"
                    v-model="TransportModeValue" autocomplete="off" @change="transportModeCode($event)" />
                  <label for="RailRadio" class="fontssetlabelRechanges">Rail</label>
                </div>
                <div class="invoice_radio_button">
                  <input :disabled="isDisable" type="radio" class="invoice_radio" id="AirRadio" name="radiomode" value="Air"
                    v-model="TransportModeValue" autocomplete="off" @change="transportModeCode($event)" />
                  <label for="AirRadio" class="fontssetlabelRechanges">Air</label>
                </div>
                <div class="invoice_radio_button">
                  <input :disabled="isDisable" type="radio" class="invoice_radio" id="ShipRadio" name="radiomode" value="ShipRadio"
                    v-model="TransportModeValue" autocomplete="off" @change="transportModeCode($event)" />
            ...
            <div class="col-lg-6 col-12 mb-2">
              <div class="SupplyTypeRadioButton">
                ...
                <div class="invoice_radio_button">
                  <input :disabled="isDisable" @change="VehicleTypeModeCode($event)" type="radio" class="invoice_radio" id="RegularRadio"
                ...
                <div class="invoice_radio_button">
                  <input :disabled="isDisable" type="radio" class="invoice_radio" id="OverRadio" name="radiovehicle" value="Over"
          ...
          <div class="row align-items-center mt-2">
            <div class="col-lg-6 col-12 mb-2">
              <div class="eWayBillDetailsPopupInputText eWayBillDetailsPopupPartBDetailsInputText">
                ...
                <input :disabled="isDisable" v-model="vehicleNumberValue" type="text" placeholder="Enter No" @keydown="handleKeyDown"
                  v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
              </div>
            ...
            <!-- <div class="col-lg-6 col-12 mb-2">
              <div class="eWayBillDetailsPopupInputText eWayBillDetailsPopupPartBDetailsInputTextwithDatepicker">
                ...
                <input :disabled="isDisable" type="text" placeholder="eg. D123456" @keydown="handleKeyDown" v-on:keydown="disableArrowKeys"
                  v-on:wheel="disableMouseWheelScroll" />
                <div class="eWayBillDetailsPopupInputDatepicker">
                  <span class="DocDateDatePicker">
                    <img src="/assets/images/1.0/sales/calendar.svg" class="img-fluid" />
          ...
          <div class="row">
            <div class="col-lg-3 col-12">
              ...
              <div class="BillFromDispatchFrom mb-2">
                ...
                <input :disabled="isDisable" disabled type="text" placeholder="Enter GSTIN" @keydown="handleKeyDown"
            ...
            <div class="col-lg-3 col-12">
              ...
              <div class="DispatchFromBoxDivPinState mb-2">
                <label class="eWayBillDetailsPopupLabel setWidthDispatchFromLabel">Pin & State <span
                    class="Validationspanerror">*</span></label>
                <input :disabled="isDisable" v-model="DispatchPincode" type="text" placeholder="Enter" @keydown="handleKeyDown"
                  v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
            ...
            <div class="col-lg-3 col-12">
              ...
              <div class="BillFromDispatchFrom mb-2">
                ...
                <input :disabled="isDisable" disabled v-model="BuyerGstin" type="text" placeholder="Enter GSTIN" @keydown="handleKeyDown"
                  v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
              </div>
              <div class="BillFromDispatchFrom mb-2">
            ...
            <div class="col-lg-3 col-12">
              ...
              <div class="DispatchFromBoxDivPinState mb-2">
                ...
                <input :disabled="isDisable" v-model="consigneePostalCode" type="text" placeholder="Enter" @keydown="handleKeyDown"
                  v-on:keydown="disableArrowKeys" v-on:wheel="disableMouseWheelScroll" />
                <select v-model="consigneestateSearchQuery">
                  <option disabled value="">Select State</option>
                  <option v-for="(option, index) in stateData" :key="index" :value="option.name">
...
export default {
  ...
  data() {
    return {isGstCalculated: true,
      ...
      isWordLimitExceededForDescription: false,
      service_error: {},
      isPaid: "0",
      narration: "",
      buyerAddress: "",
  ...
  watch: {
    ...
    voucherSearchQuery(newVal) {
      if(!this.$route.query.voucherIdFromQuotation){
  ...
  methods: {
    revertBack() {
      if(this.voucherSyncId){
        GoogleAnalytics.SalesOrder_Revert_Back_Voucher();
      }
      else{
        GoogleAnalytics.SalesOrder_Delete_Voucher();
      }
        const data = {
      ...
      Api.getInvoiceConfigurationsGo(data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            this.invoice_type =
              CommonResponse.voucherNumberConfiguration.salesorder.isSetDefaultNumber;
            this.isEwayStatus = CommonResponse.isEwayStatus;
            this.customizeVoucherNumber =
              CommonResponse.voucherNumberConfiguration.salesorder.customizeVoucherNumber;
            ...
            if (this.$route.params.voucher_id !== undefined) {
              this.customizeVoucherNumber.isSalesOrderNumber =
                Number(response.data.data.vouchers.voucherNumberConfiguration.salesorder.customizeVoucherNumber.number) - 1;
            }
            else {
              this.customizeVoucherNumber.isSalesOrderNumber =
    ...
    change_description(event, index) {
      ...
      const words = this.narration.trim().split(/\s+/).filter(word => word);
      if (words.length > wordLimit) {
        this.isWordLimitExceededForDescription = true;
        this.tempItmesObject[index].descriptions = words.slice(0, wordLimit).join(" ");
        this.$refs.descriptionInputs[index].blur();
      } else {
        this.isWordLimitExceededForDescription = false;
      }
    },
      ...
      this.AddNewItemList.forEach((value, key) => {
        if (this.AddNewItemList[key].isChecked == true) {
          ...
          var inner_object = {
            ...
            itemSyncId: value.item_guid == "" ? value.item_id : "",
            itemQty: value.itemquantity ? parseFloat(value.itemquantity).toFixed(this.totalDecimalValue).toString() : "",
            itemRate: isNaN(value.itemrate) ? "0" : parseFloat(value.itemrate).toFixed(this.totalDecimalValueForRate),
            discountPercent: value.itemdiscount,
            isTaxInclusive: this.AddNewItemList[key].isChecked,
            gstPercent: "",
            serialNo: key + 1,
      ...
      Api[api](data, headers)
        .then((response) => {
          ...
          if (responseData == "200") {
            ...
            // if(this.$route.query.voucherIdFromQuotation == undefined){
    ...
    update_sales() {
      ...
      if (Object.keys(this.stockItemsError).length === 0) {
        ...
        const isEdit = String(this.$route.query.isEdit) === '1';
        console.log(this.order_terms_of_payment,"payment options")
        const data = {
          voucherId: this.$route.params.voucher_id,
    ...
    toggleDropdown(dropdownType, open) {
      ...
      // this.getledgerlist()
      if (dropdownType == "partyname" && this.$route.query.voucherIdFromQuotation == undefined) {
         if(open){
    ...
    selectOtherLedgersOption(option, index) {
      ...
      console.log(this.AddOtherLedgersListDropdown, "Others ledgers selected");
      console.log(this.ledger_array, "Others ledgersarray selected");
    },
    ...
    cancelOrDeleteVoucher() {
      GoogleAnalytics.SalesOrder_Cancel_Voucher();
  ...
  mounted() {
    ...
    if (this.$route.params.voucher_id !== undefined || this.$route.query.voucherIdFromQuotation) {
      this.selectionDone = true
      this.get_Sales_data();
      this.getlocationlist();
