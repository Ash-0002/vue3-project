              ...
              <v-app id="inspire">
                ...
                >
                  <v-data-table
                    ...
                    :options.sync="options"
                    :items-per-page="
                      this.$store.state.Web1_Store.Purchase_StockItem_itemsPerPage
                    "
                    :server-items-length="totalsalecustomer"
                    :loading="loading"
                    class="elevation-1"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      page: this.$store.state.Web1_Store.Purchase_StockItem_page,
      totalsalecustomer: 0,
      numberOfPages: 0,
      salecustomer: [],
      value: [],
  ...
  watch: {
    page: function () {
      ...
      this.sale_data();
      GoogleAnalytics.purchase_stock_item_screen_pagination(this.options.page);
    },
    ...
    "options.itemsPerPage"() {
      ...
      setTimeout(() => {
        const StartIndex =
          (this.$store.state.Web1_Store.Purchase_StockItem_page - 1) *
          this.$store.state.Web1_Store.Purchase_StockItem_itemsPerPage;
        const endIndex =
          StartIndex + this.$store.state.Web1_Store.Purchase_StockItem_itemsPerPage;
        ...
        if (Difference > this.totalsalecustomer) {
          ...
          this.page = this.$store.state.Web1_Store.Purchase_StockItem_page;
          this.options.page = this.page;
        }
      }, 1000);
      ...
      if (this.call_function == "1") {
        ...
        GoogleAnalytics.purchase_stock_item_screen_Rows_Per_Page(
    ...
    options: {
      handler() {
        ...
        GoogleAnalytics.purchase_stock_item_listing();
      },
    },
    deep: true,
  },
  ...
  computed: {
    currentPage() {
      return this.$store.state.Web1_Store.Purchase_StockItem_page;
    },
  },
  methods: {
    freeusergeneratePdf() {
      GoogleAnalytics.purchase_stock_item_screen_viewpdf("viewpdf");
    },
    StoredPage(newValue) {
      this.$store.dispatch("Web1_Store/setPurchaseStockItemPage", newValue.page);
    },
    updateItemsPerPage(newValue) {
      this.$store.dispatch("Web1_Store/setPurchaseStockItemItemsPerPage", newValue);
    },
    generatePdf() {
      GoogleAnalytics.purchase_stock_item_screen_viewpdf("viewpdf");
      const data = {
    ...
    activatedate: function (date) {
      if (date === "oned") {
        // one day
        GoogleAnalytics.purchase_stock_item_screen_date_filter("1D");
        ...
        // one week
        GoogleAnalytics.purchase_stock_item_screen_date_filter("1W");
        ...
        // one month
        GoogleAnalytics.purchase_stock_item_screen_date_filter("1M");
        ...
        // 3 month
        GoogleAnalytics.purchase_stock_item_screen_date_filter("3M");
        var new_date_start_date = moment(String(new Date()))
          .add(-3, "M")
          .format("yyyy-MM-DD");
        var new_date_end_date = moment(String(new Date())).format("yyyy-MM-DD");
        ...
        // 1 Year
        GoogleAnalytics.purchase_stock_item_screen_date_filter("1Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // 2 Year
        GoogleAnalytics.purchase_stock_item_screen_date_filter("2Y");
        var new_date_start_date = moment(
          String(
            new Date(
              String(localStorage.getItem("first_date_range_start_date"))
        ...
        // max date
        GoogleAnalytics.purchase_stock_item_screen_date_filter("Max");
        var new_date_start_date = moment(
    ...
    handleBlur() {
      const type = "search";
      GoogleAnalytics.purchase_stock_item_screen_search(this.search);
    ...
    updateSort(byDesc, event) {
      ...
      GoogleAnalytics.purchase_stock_item_screen_sorting(
        this.sortBy,
        this.orderBy
      );
    ...
    update() {
      ...
      GoogleAnalytics.purchase_stock_item_screen_date_filter("Custom");
      this.sale_data("", this.groupSelectValue, this.switch_type);
      this.date_setting();
    },
    date_setting() {
